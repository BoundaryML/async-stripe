...
use crate::resources::{
    ...
    Discount, PaymentMethod, Plan, Price, PromotionCode, Scheduled, Subscription,
    SubscriptionBillingThresholds, SubscriptionItemBillingThresholds, SubscriptionTransferData,
    SubscriptionsResourceBillingMode, TaxId, TaxRate, TestHelpersTestClock,
};
...
impl SchedulesPhaseAutomaticTaxDisabledReason {
    pub fn as_str(self) -> &'static str {
        match self {
            SchedulesPhaseAutomaticTaxDisabledReason::RequiresLocationInputs => {
