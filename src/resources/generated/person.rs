...
/// An enum representing the possible values of an `PersonEthnicityDetails`'s `ethnicity` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl PersonEthnicityDetailsEthnicity {
    pub fn as_str(self) -> &'static str {
        match self {
            PersonEthnicityDetailsEthnicity::Cuban => "cuban",
            PersonEthnicityDetailsEthnicity::HispanicOrLatino => "hispanic_or_latino",
            PersonEthnicityDetailsEthnicity::Mexican => "mexican",
            PersonEthnicityDetailsEthnicity::NotHispanicOrLatino => "not_hispanic_or_latino",
            PersonEthnicityDetailsEthnicity::OtherHispanicOrLatino => "other_hispanic_or_latino",
            PersonEthnicityDetailsEthnicity::PreferNotToAnswer => "prefer_not_to_answer",
            PersonEthnicityDetailsEthnicity::PuertoRican => "puerto_rican",
        }
    }
}

impl AsRef<str> for PersonEthnicityDetailsEthnicity {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for PersonEthnicityDetailsEthnicity {
    fn default() -> Self {
        Self::Cuban
    }
}
...
/// An enum representing the possible values of an `PersonRaceDetails`'s `race` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl PersonRaceDetailsRace {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            PersonRaceDetailsRace::Chinese => "chinese",
            PersonRaceDetailsRace::Ethiopian => "ethiopian",
            PersonRaceDetailsRace::Filipino => "filipino",
            PersonRaceDetailsRace::GuamanianOrChamorro => "guamanian_or_chamorro",
            PersonRaceDetailsRace::Haitian => "haitian",
            PersonRaceDetailsRace::Jamaican => "jamaican",
            ...
            PersonRaceDetailsRace::OtherPacificIslander => "other_pacific_islander",
            PersonRaceDetailsRace::PreferNotToAnswer => "prefer_not_to_answer",
            PersonRaceDetailsRace::Samoan => "samoan",
            PersonRaceDetailsRace::Somali => "somali",
            PersonRaceDetailsRace::Vietnamese => "vietnamese",
            PersonRaceDetailsRace::White => "white",
        }
    }
}

impl AsRef<str> for PersonRaceDetailsRace {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for PersonRaceDetailsRace {
    fn default() -> Self {
