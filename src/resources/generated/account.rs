...
pub fn list(client: &Client, params: &ListAccounts<'_>) -> Response<List<Account>> {
   client.get_query("/accounts", params)
    ...
    ///
    /// Any parameters not provided are left unchanged.  For accounts where <a href="/api/accounts/object#account_object-controller-requirement_collection">controller.requirement_collection</a> is `application`, which includes Custom accounts, you can update any information on the account.  For accounts where <a href="/api/accounts/object#account_object-controller-requirement_collection">controller.requirement_collection</a> is `stripe`, which includes Standard and Express accounts, you can update all information until you create an <a href="/api/account_links">Account Link</a> or <a href="/api/account_sessions">Account Session</a> to start Connect onboarding, after which some properties can no longer be updated.  To update your own account, use the [Dashboard](https://dashboard.stripe.com/settings/account).
    ...
    ///
    /// All other Live-mode accounts, can be deleted when all <a href="/api/balance/balance_object">balances</a> are zero.  If you want to delete your own account, use the [account information tab in your account settings](https://dashboard.stripe.com/settings/account) instead.
...
pub struct BusinessProfile {
    ...
    pub minority_owned_business_designation: Option<Vec<BusinessProfileMinorityOwnedBusinessDesignation>>,
...
pub struct AccountCapabilities {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub alma_payments: Option<AccountCapabilitiesAlmaPayments>,

    /// The status of the AmazonPay capability of the account, or whether the account can directly process AmazonPay payments.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub amazon_pay_payments: Option<AccountCapabilitiesAmazonPayPayments>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub billie_payments: Option<AccountCapabilitiesBilliePayments>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub crypto_payments: Option<AccountCapabilitiesCryptoPayments>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub gb_bank_transfer_payments: Option<AccountCapabilitiesGbBankTransferPayments>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub jp_bank_transfer_payments: Option<AccountCapabilitiesJpBankTransferPayments>,

    /// The status of the KakaoPay capability of the account, or whether the account can directly process KakaoPay payments.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub kakao_pay_payments: Option<AccountCapabilitiesKakaoPayPayments>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub kr_card_payments: Option<AccountCapabilitiesKrCardPayments>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub mobilepay_payments: Option<AccountCapabilitiesMobilepayPayments>,

    /// The status of the Multibanco payments capability of the account, or whether the account can directly process Multibanco charges.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub multibanco_payments: Option<AccountCapabilitiesMultibancoPayments>,

    /// The status of the Mexican customer_balance payments (MXN currency) capability of the account, or whether the account can directly process Mexican customer_balance charges.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub mx_bank_transfer_payments: Option<AccountCapabilitiesMxBankTransferPayments>,

    /// The status of the NaverPay capability of the account, or whether the account can directly process NaverPay payments.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub naver_pay_payments: Option<AccountCapabilitiesNaverPayPayments>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub nz_bank_account_becs_debit_payments: Option<AccountCapabilitiesNzBankAccountBecsDebitPayments>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub pay_by_bank_payments: Option<AccountCapabilitiesPayByBankPayments>,

    /// The status of the Payco capability of the account, or whether the account can directly process Payco payments.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub payco_payments: Option<AccountCapabilitiesPaycoPayments>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub pix_payments: Option<AccountCapabilitiesPixPayments>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub samsung_pay_payments: Option<AccountCapabilitiesSamsungPayPayments>,

    /// The status of the Satispay capability of the account, or whether the account can directly process Satispay payments.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub satispay_payments: Option<AccountCapabilitiesSatispayPayments>,

    /// The status of the SEPA customer_balance payments (EUR currency) capability of the account, or whether the account can directly process SEPA customer_balance charges.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub sepa_bank_transfer_payments: Option<AccountCapabilitiesSepaBankTransferPayments>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub twint_payments: Option<AccountCapabilitiesTwintPayments>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub us_bank_transfer_payments: Option<AccountCapabilitiesUsBankTransferPayments>,
...
pub struct Company {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub ownership_exemption_reason: Option<CompanyOwnershipExemptionReason>,
...
pub struct CreateAccount<'a> {
    ...
    /// maps to its settings (for example, whether it has been requested or not).
    ///
    /// Each capability is inactive until you have provided its specific requirements and Stripe has verified them.
    /// An account might have some of its requested capabilities be active and some be inactive.  Required when [account.controller.stripe_dashboard.type](/api/accounts/create#create_account-controller-dashboard-type) is `none`, which includes Custom accounts.
    #[serde(skip_serializing_if = "Option::is_none")]
    ...
    ///
    /// These are account groups this account should be added to.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub groups: Option<CreateAccountGroups>,
...
pub struct UpdateAccount<'a> {
    ...
    /// These are account groups this account should be added to.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub groups: Option<UpdateAccountGroups>,
...
pub struct AccountSettingsParams {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub invoices: Option<AccountSettingsParamsInvoices>,
...
pub struct CompanyParams {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub directorship_declaration: Option<CompanyParamsDirectorshipDeclaration>,
    ...
    /// See [this support article](https://support.stripe.com/questions/exemption-from-providing-ownership-details) and [changelog](https://docs.stripe.com/changelog/acacia/2025-01-27/ownership-exemption-reason-accounts-api) for more details.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub ownership_exemption_reason: Option<CompanyParamsOwnershipExemptionReason>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub registration_date: Option<CompanyParamsRegistrationDate>,
...
pub struct CreateAccountCapabilities {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub nz_bank_account_becs_debit_payments: Option<CreateAccountCapabilitiesNzBankAccountBecsDebitPayments>,
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct CreateAccountGroups {
...
pub struct UpdateAccountCapabilities {
    ...
    /// The nz_bank_account_becs_debit_payments capability.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub nz_bank_account_becs_debit_payments: Option<UpdateAccountCapabilitiesNzBankAccountBecsDebitPayments>,
...
pub struct UpdateAccountDocuments {
    ...
    /// One or more documents that demonstrate proof of ultimate beneficial ownership.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub proof_of_ultimate_beneficial_ownership: Option<UpdateAccountDocumentsProofOfUltimateBeneficialOwnership>,
}

#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct UpdateAccountGroups {
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct AccountSettingsParamsInvoices {

    /// Whether payment methods should be saved when a payment is completed for a one-time invoices on a hosted invoice page.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub hosted_payment_method_save: Option<AccountSettingsParamsInvoicesHostedPaymentMethodSave>,
}
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct CompanyParamsDirectorshipDeclaration {
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct CompanyParamsRegistrationDate {
...
pub struct TransferScheduleParams {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub weekly_payout_days: Option<Vec<TransferScheduleParamsWeeklyPayoutDays>>,
}
...
/// An enum representing the possible values of an `AccountCapabilities`'s `alma_payments` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum AccountCapabilitiesAlmaPayments {
    Active,
    Inactive,
    Pending,
}

impl AccountCapabilitiesAlmaPayments {
    pub fn as_str(self) -> &'static str {
        match self {
...
impl AsRef<str> for AccountCapabilitiesAlmaPayments {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for AccountCapabilitiesAlmaPayments {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for AccountCapabilitiesAlmaPayments {
    fn default() -> Self {
        Self::Active
    }
}

/// An enum representing the possible values of an `AccountCapabilities`'s `amazon_pay_payments` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum AccountCapabilitiesAmazonPayPayments {
    Active,
    Inactive,
    Pending,
}
...
impl AsRef<str> for AccountCapabilitiesAmazonPayPayments {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for AccountCapabilitiesAmazonPayPayments {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for AccountCapabilitiesAmazonPayPayments {
    fn default() -> Self {
        Self::Active
    }
}
...
/// An enum representing the possible values of an `AccountCapabilities`'s `billie_payments` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum AccountCapabilitiesBilliePayments {
    Active,
    Inactive,
    Pending,
}

impl AccountCapabilitiesBilliePayments {
    pub fn as_str(self) -> &'static str {
        match self {
...
impl AsRef<str> for AccountCapabilitiesBilliePayments {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for AccountCapabilitiesBilliePayments {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for AccountCapabilitiesBilliePayments {
    fn default() -> Self {
        Self::Active
    }
}
...
/// An enum representing the possible values of an `AccountCapabilities`'s `crypto_payments` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum AccountCapabilitiesCryptoPayments {
    Active,
    Inactive,
    Pending,
}

impl AccountCapabilitiesCryptoPayments {
    pub fn as_str(self) -> &'static str {
        match self {
...
impl AsRef<str> for AccountCapabilitiesCryptoPayments {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for AccountCapabilitiesCryptoPayments {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for AccountCapabilitiesCryptoPayments {
    fn default() -> Self {
        Self::Active
    }
}
...
/// An enum representing the possible values of an `AccountCapabilities`'s `gb_bank_transfer_payments` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum AccountCapabilitiesGbBankTransferPayments {
    Active,
    Inactive,
    Pending,
}

impl AccountCapabilitiesGbBankTransferPayments {
    pub fn as_str(self) -> &'static str {
        match self {
...
impl AsRef<str> for AccountCapabilitiesGbBankTransferPayments {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for AccountCapabilitiesGbBankTransferPayments {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for AccountCapabilitiesGbBankTransferPayments {
    fn default() -> Self {
        Self::Active
    }
}
...
/// An enum representing the possible values of an `AccountCapabilities`'s `jp_bank_transfer_payments` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum AccountCapabilitiesJpBankTransferPayments {
    Active,
    Inactive,
    Pending,
}

impl AccountCapabilitiesJpBankTransferPayments {
    pub fn as_str(self) -> &'static str {
        match self {
...
impl AsRef<str> for AccountCapabilitiesJpBankTransferPayments {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for AccountCapabilitiesJpBankTransferPayments {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for AccountCapabilitiesJpBankTransferPayments {
    fn default() -> Self {
        Self::Active
    }
}

/// An enum representing the possible values of an `AccountCapabilities`'s `kakao_pay_payments` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum AccountCapabilitiesKakaoPayPayments {
    Active,
    Inactive,
    Pending,
}

impl AccountCapabilitiesKakaoPayPayments {
    pub fn as_str(self) -> &'static str {
        match self {
...
impl AsRef<str> for AccountCapabilitiesKakaoPayPayments {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for AccountCapabilitiesKakaoPayPayments {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for AccountCapabilitiesKakaoPayPayments {
    fn default() -> Self {
        Self::Active
    }
}
...
/// An enum representing the possible values of an `AccountCapabilities`'s `kr_card_payments` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum AccountCapabilitiesKrCardPayments {
    Active,
    Inactive,
    Pending,
}

impl AccountCapabilitiesKrCardPayments {
    pub fn as_str(self) -> &'static str {
        match self {
...
impl AsRef<str> for AccountCapabilitiesKrCardPayments {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for AccountCapabilitiesKrCardPayments {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for AccountCapabilitiesKrCardPayments {
    fn default() -> Self {
        Self::Active
    }
}
...
/// An enum representing the possible values of an `AccountCapabilities`'s `mobilepay_payments` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum AccountCapabilitiesMobilepayPayments {
    Active,
    Inactive,
    Pending,
}

impl AccountCapabilitiesMobilepayPayments {
    pub fn as_str(self) -> &'static str {
        match self {
...
impl AsRef<str> for AccountCapabilitiesMobilepayPayments {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for AccountCapabilitiesMobilepayPayments {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for AccountCapabilitiesMobilepayPayments {
    fn default() -> Self {
        Self::Active
    }
}

/// An enum representing the possible values of an `AccountCapabilities`'s `multibanco_payments` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum AccountCapabilitiesMultibancoPayments {
    Active,
    Inactive,
    Pending,
}

impl AccountCapabilitiesMultibancoPayments {
    pub fn as_str(self) -> &'static str {
        match self {
...
impl AsRef<str> for AccountCapabilitiesMultibancoPayments {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for AccountCapabilitiesMultibancoPayments {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for AccountCapabilitiesMultibancoPayments {
    fn default() -> Self {
        Self::Active
    }
}

/// An enum representing the possible values of an `AccountCapabilities`'s `mx_bank_transfer_payments` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum AccountCapabilitiesMxBankTransferPayments {
    Active,
    Inactive,
    Pending,
}

impl AccountCapabilitiesMxBankTransferPayments {
    pub fn as_str(self) -> &'static str {
        match self {
...
impl AsRef<str> for AccountCapabilitiesMxBankTransferPayments {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for AccountCapabilitiesMxBankTransferPayments {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for AccountCapabilitiesMxBankTransferPayments {
    fn default() -> Self {
        Self::Active
    }
}

/// An enum representing the possible values of an `AccountCapabilities`'s `naver_pay_payments` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum AccountCapabilitiesNaverPayPayments {
    Active,
    Inactive,
    Pending,
}

impl AccountCapabilitiesNaverPayPayments {
    pub fn as_str(self) -> &'static str {
        match self {
...
impl AsRef<str> for AccountCapabilitiesNaverPayPayments {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for AccountCapabilitiesNaverPayPayments {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for AccountCapabilitiesNaverPayPayments {
    fn default() -> Self {
        Self::Active
    }
}

/// An enum representing the possible values of an `AccountCapabilities`'s `nz_bank_account_becs_debit_payments` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum AccountCapabilitiesNzBankAccountBecsDebitPayments {
    Active,
    Inactive,
    Pending,
}

impl AccountCapabilitiesNzBankAccountBecsDebitPayments {
    pub fn as_str(self) -> &'static str {
        match self {
...
impl AsRef<str> for AccountCapabilitiesNzBankAccountBecsDebitPayments {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for AccountCapabilitiesNzBankAccountBecsDebitPayments {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for AccountCapabilitiesNzBankAccountBecsDebitPayments {
    fn default() -> Self {
        Self::Active
    }
}
...
/// An enum representing the possible values of an `AccountCapabilities`'s `pay_by_bank_payments` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum AccountCapabilitiesPayByBankPayments {
    Active,
    Inactive,
    Pending,
}

impl AccountCapabilitiesPayByBankPayments {
    pub fn as_str(self) -> &'static str {
        match self {
...
impl AsRef<str> for AccountCapabilitiesPayByBankPayments {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for AccountCapabilitiesPayByBankPayments {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for AccountCapabilitiesPayByBankPayments {
    fn default() -> Self {
        Self::Active
    }
}

/// An enum representing the possible values of an `AccountCapabilities`'s `payco_payments` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum AccountCapabilitiesPaycoPayments {
    Active,
    Inactive,
    Pending,
}

impl AccountCapabilitiesPaycoPayments {
    pub fn as_str(self) -> &'static str {
        match self {
...
impl AsRef<str> for AccountCapabilitiesPaycoPayments {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for AccountCapabilitiesPaycoPayments {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for AccountCapabilitiesPaycoPayments {
    fn default() -> Self {
        Self::Active
    }
}
...
/// An enum representing the possible values of an `AccountCapabilities`'s `pix_payments` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum AccountCapabilitiesPixPayments {
    Active,
    Inactive,
    Pending,
}

impl AccountCapabilitiesPixPayments {
    pub fn as_str(self) -> &'static str {
        match self {
...
impl AsRef<str> for AccountCapabilitiesPixPayments {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for AccountCapabilitiesPixPayments {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for AccountCapabilitiesPixPayments {
    fn default() -> Self {
        Self::Active
    }
}
...
/// An enum representing the possible values of an `AccountCapabilities`'s `samsung_pay_payments` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum AccountCapabilitiesSamsungPayPayments {
    Active,
    Inactive,
    Pending,
}

impl AccountCapabilitiesSamsungPayPayments {
    pub fn as_str(self) -> &'static str {
        match self {
...
impl AsRef<str> for AccountCapabilitiesSamsungPayPayments {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for AccountCapabilitiesSamsungPayPayments {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for AccountCapabilitiesSamsungPayPayments {
    fn default() -> Self {
        Self::Active
    }
}

/// An enum representing the possible values of an `AccountCapabilities`'s `satispay_payments` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum AccountCapabilitiesSatispayPayments {
    Active,
    Inactive,
    Pending,
}

impl AccountCapabilitiesSatispayPayments {
    pub fn as_str(self) -> &'static str {
        match self {
...
impl AsRef<str> for AccountCapabilitiesSatispayPayments {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for AccountCapabilitiesSatispayPayments {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for AccountCapabilitiesSatispayPayments {
    fn default() -> Self {
        Self::Active
    }
}

/// An enum representing the possible values of an `AccountCapabilities`'s `sepa_bank_transfer_payments` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum AccountCapabilitiesSepaBankTransferPayments {
    Active,
    Inactive,
    Pending,
}

impl AccountCapabilitiesSepaBankTransferPayments {
    pub fn as_str(self) -> &'static str {
        match self {
...
impl AsRef<str> for AccountCapabilitiesSepaBankTransferPayments {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for AccountCapabilitiesSepaBankTransferPayments {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for AccountCapabilitiesSepaBankTransferPayments {
    fn default() -> Self {
        Self::Active
    }
}
...
/// An enum representing the possible values of an `AccountCapabilities`'s `twint_payments` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum AccountCapabilitiesTwintPayments {
    Active,
    Inactive,
    Pending,
}

impl AccountCapabilitiesTwintPayments {
    pub fn as_str(self) -> &'static str {
        match self {
...
impl AsRef<str> for AccountCapabilitiesTwintPayments {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for AccountCapabilitiesTwintPayments {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for AccountCapabilitiesTwintPayments {
    fn default() -> Self {
        Self::Active
    }
}
...
/// An enum representing the possible values of an `AccountCapabilities`'s `us_bank_transfer_payments` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum AccountCapabilitiesUsBankTransferPayments {
    Active,
    Inactive,
    Pending,
}

impl AccountCapabilitiesUsBankTransferPayments {
    pub fn as_str(self) -> &'static str {
        match self {
...
impl AsRef<str> for AccountCapabilitiesUsBankTransferPayments {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for AccountCapabilitiesUsBankTransferPayments {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for AccountCapabilitiesUsBankTransferPayments {
    fn default() -> Self {
        Self::Active
    }
}
...
/// An enum representing the possible values of an `AccountFutureRequirements`'s `disabled_reason` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum AccountFutureRequirementsDisabledReason {
    #[serde(rename = "action_required.requested_capabilities")]
    ...
    RejectedFraud,
    #[serde(rename = "rejected.incomplete_verification")]
    RejectedIncompleteVerification,
    #[serde(rename = "rejected.listed")]
    RejectedListed,
    #[serde(rename = "rejected.other")]
    RejectedOther,
    #[serde(rename = "rejected.platform_fraud")]
    RejectedPlatformFraud,
    #[serde(rename = "rejected.platform_other")]
    RejectedPlatformOther,
    #[serde(rename = "rejected.platform_terms_of_service")]
...
impl AccountFutureRequirementsDisabledReason {
    pub fn as_str(self) -> &'static str {
        match self {
            AccountFutureRequirementsDisabledReason::ActionRequiredRequestedCapabilities => "action_required.requested_capabilities",
            AccountFutureRequirementsDisabledReason::Listed => "listed",
            AccountFutureRequirementsDisabledReason::Other => "other",
            AccountFutureRequirementsDisabledReason::PlatformPaused => "platform_paused",
            AccountFutureRequirementsDisabledReason::RejectedFraud => "rejected.fraud",
            AccountFutureRequirementsDisabledReason::RejectedIncompleteVerification => "rejected.incomplete_verification",
            AccountFutureRequirementsDisabledReason::RejectedListed => "rejected.listed",
            AccountFutureRequirementsDisabledReason::RejectedOther => "rejected.other",
            AccountFutureRequirementsDisabledReason::RejectedPlatformFraud => "rejected.platform_fraud",
            AccountFutureRequirementsDisabledReason::RejectedPlatformOther => "rejected.platform_other",
            AccountFutureRequirementsDisabledReason::RejectedPlatformTermsOfService => "rejected.platform_terms_of_service",
            AccountFutureRequirementsDisabledReason::RejectedTermsOfService => "rejected.terms_of_service",
            AccountFutureRequirementsDisabledReason::RequirementsPastDue => "requirements.past_due",
            AccountFutureRequirementsDisabledReason::RequirementsPendingVerification => "requirements.pending_verification",
            AccountFutureRequirementsDisabledReason::UnderReview => "under_review",
        }
    }
}

impl AsRef<str> for AccountFutureRequirementsDisabledReason {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for AccountFutureRequirementsDisabledReason {
    fn default() -> Self {
        Self::ActionRequiredRequestedCapabilities
    }
}

/// An enum representing the possible values of an `AccountInvoicesSettings`'s `hosted_payment_method_save` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl AsRef<str> for AccountInvoicesSettingsHostedPaymentMethodSave {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for AccountInvoicesSettingsHostedPaymentMethodSave {
    fn default() -> Self {
        Self::Always
    }
}

/// An enum representing the possible values of an `AccountRequirements`'s `disabled_reason` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl AccountRequirementsDisabledReason {
    pub fn as_str(self) -> &'static str {
        match self {
            AccountRequirementsDisabledReason::ActionRequiredRequestedCapabilities => "action_required.requested_capabilities",
            AccountRequirementsDisabledReason::Listed => "listed",
            AccountRequirementsDisabledReason::Other => "other",
            AccountRequirementsDisabledReason::PlatformPaused => "platform_paused",
            AccountRequirementsDisabledReason::RejectedFraud => "rejected.fraud",
            AccountRequirementsDisabledReason::RejectedIncompleteVerification => "rejected.incomplete_verification",
            AccountRequirementsDisabledReason::RejectedListed => "rejected.listed",
            AccountRequirementsDisabledReason::RejectedOther => "rejected.other",
            AccountRequirementsDisabledReason::RejectedPlatformFraud => "rejected.platform_fraud",
            AccountRequirementsDisabledReason::RejectedPlatformOther => "rejected.platform_other",
            AccountRequirementsDisabledReason::RejectedPlatformTermsOfService => "rejected.platform_terms_of_service",
            AccountRequirementsDisabledReason::RejectedTermsOfService => "rejected.terms_of_service",
            AccountRequirementsDisabledReason::RequirementsPastDue => "requirements.past_due",
            AccountRequirementsDisabledReason::RequirementsPendingVerification => "requirements.pending_verification",
            AccountRequirementsDisabledReason::UnderReview => "under_review",
        }
    }
}

impl AsRef<str> for AccountRequirementsDisabledReason {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for AccountRequirementsDisabledReason {
    fn default() -> Self {
        Self::ActionRequiredRequestedCapabilities
    }
}
...
impl AccountRequirementsErrorCode {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            AccountRequirementsErrorCode::VerificationLegalEntityStructureMismatch => "verification_legal_entity_structure_mismatch",
...
/// An enum representing the possible values of an `AccountSettingsParamsInvoices`'s `hosted_payment_method_save` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum AccountSettingsParamsInvoicesHostedPaymentMethodSave {
    Always,
    Never,
    Offer,
}

impl AccountSettingsParamsInvoicesHostedPaymentMethodSave {
    pub fn as_str(self) -> &'static str {
        match self {
            AccountSettingsParamsInvoicesHostedPaymentMethodSave::Always => "always",
            AccountSettingsParamsInvoicesHostedPaymentMethodSave::Never => "never",
            AccountSettingsParamsInvoicesHostedPaymentMethodSave::Offer => "offer",
        }
    }
}

impl AsRef<str> for AccountSettingsParamsInvoicesHostedPaymentMethodSave {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for AccountSettingsParamsInvoicesHostedPaymentMethodSave {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for AccountSettingsParamsInvoicesHostedPaymentMethodSave {
    fn default() -> Self {
        Self::Always
    }
}
...
impl AccountUnificationAccountControllerFeesPayer {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            AccountUnificationAccountControllerFeesPayer::ApplicationExpress => "application_express",
        }
    }
}
...
/// An enum representing the possible values of an `BusinessProfile`'s `minority_owned_business_designation` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum BusinessProfileMinorityOwnedBusinessDesignation {
    LgbtqiOwnedBusiness,
...
impl BusinessProfileMinorityOwnedBusinessDesignation {
    pub fn as_str(self) -> &'static str {
        match self {
            BusinessProfileMinorityOwnedBusinessDesignation::LgbtqiOwnedBusiness => "lgbtqi_owned_business",
            BusinessProfileMinorityOwnedBusinessDesignation::MinorityOwnedBusiness => "minority_owned_business",
            BusinessProfileMinorityOwnedBusinessDesignation::NoneOfTheseApply => "none_of_these_apply",
            BusinessProfileMinorityOwnedBusinessDesignation::PreferNotToAnswer => "prefer_not_to_answer",
            BusinessProfileMinorityOwnedBusinessDesignation::WomenOwnedBusiness => "women_owned_business",
        }
    }
}

impl AsRef<str> for BusinessProfileMinorityOwnedBusinessDesignation {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for BusinessProfileMinorityOwnedBusinessDesignation {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for BusinessProfileMinorityOwnedBusinessDesignation {
    fn default() -> Self {
        Self::LgbtqiOwnedBusiness
    }
}
...
/// An enum representing the possible values of an `Company`'s `ownership_exemption_reason` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum CompanyOwnershipExemptionReason {
    QualifiedEntityExceedsOwnershipThreshold,
    QualifiesAsFinancialInstitution,
}

impl CompanyOwnershipExemptionReason {
    pub fn as_str(self) -> &'static str {
        match self {
            CompanyOwnershipExemptionReason::QualifiedEntityExceedsOwnershipThreshold => "qualified_entity_exceeds_ownership_threshold",
            CompanyOwnershipExemptionReason::QualifiesAsFinancialInstitution => "qualifies_as_financial_institution",
        }
    }
}

impl AsRef<str> for CompanyOwnershipExemptionReason {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for CompanyOwnershipExemptionReason {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for CompanyOwnershipExemptionReason {
    fn default() -> Self {
        Self::QualifiedEntityExceedsOwnershipThreshold
    }
}

/// An enum representing the possible values of an `CompanyParams`'s `ownership_exemption_reason` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum CompanyParamsOwnershipExemptionReason {
    QualifiedEntityExceedsOwnershipThreshold,
    QualifiesAsFinancialInstitution,
}

impl CompanyParamsOwnershipExemptionReason {
    pub fn as_str(self) -> &'static str {
        match self {
            CompanyParamsOwnershipExemptionReason::QualifiedEntityExceedsOwnershipThreshold => "qualified_entity_exceeds_ownership_threshold",
            CompanyParamsOwnershipExemptionReason::QualifiesAsFinancialInstitution => "qualifies_as_financial_institution",
        }
    }
}

impl AsRef<str> for CompanyParamsOwnershipExemptionReason {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for CompanyParamsOwnershipExemptionReason {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for CompanyParamsOwnershipExemptionReason {
    fn default() -> Self {
        Self::QualifiedEntityExceedsOwnershipThreshold
    }
}
...
/// An enum representing the possible values of an `TransferScheduleParams`'s `weekly_payout_days` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum TransferScheduleParamsWeeklyPayoutDays {
    Friday,
    Monday,
    Saturday,
    Sunday,
...
impl TransferScheduleParamsWeeklyPayoutDays {
    pub fn as_str(self) -> &'static str {
        match self {
            TransferScheduleParamsWeeklyPayoutDays::Friday => "friday",
            TransferScheduleParamsWeeklyPayoutDays::Monday => "monday",
            TransferScheduleParamsWeeklyPayoutDays::Saturday => "saturday",
            TransferScheduleParamsWeeklyPayoutDays::Sunday => "sunday",
            TransferScheduleParamsWeeklyPayoutDays::Thursday => "thursday",
            TransferScheduleParamsWeeklyPayoutDays::Tuesday => "tuesday",
            TransferScheduleParamsWeeklyPayoutDays::Wednesday => "wednesday",
        }
    }
}

impl AsRef<str> for TransferScheduleParamsWeeklyPayoutDays {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for TransferScheduleParamsWeeklyPayoutDays {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for TransferScheduleParamsWeeklyPayoutDays {
    fn default() -> Self {
        Self::Friday
    }
}

/// An enum representing the possible values of an `TransferSchedule`'s `weekly_payout_days` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl TransferScheduleWeeklyPayoutDays {
    pub fn as_str(self) -> &'static str {
        match self {
            TransferScheduleWeeklyPayoutDays::Friday => "friday",
            TransferScheduleWeeklyPayoutDays::Monday => "monday",
            TransferScheduleWeeklyPayoutDays::Saturday => "saturday",
            TransferScheduleWeeklyPayoutDays::Sunday => "sunday",
            TransferScheduleWeeklyPayoutDays::Thursday => "thursday",
            TransferScheduleWeeklyPayoutDays::Tuesday => "tuesday",
            TransferScheduleWeeklyPayoutDays::Wednesday => "wednesday",
        }
    }
}

impl AsRef<str> for TransferScheduleWeeklyPayoutDays {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for TransferScheduleWeeklyPayoutDays {
    fn default() -> Self {
        Self::Friday
    }
}
