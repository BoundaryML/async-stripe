...
pub struct TaxProductRegistrationsResourceCountryOptions {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub in: Option<TaxProductRegistrationsResourceCountryOptionsSimplified>,
...
/// An enum representing the possible values of an `TaxProductRegistrationsResourceCountryOptionsDefaultStandard`'s `place_of_supply_scheme` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl TaxProductRegistrationsResourceCountryOptionsDefaultStandardPlaceOfSupplyScheme {
    pub fn as_str(self) -> &'static str {
        match self {
            TaxProductRegistrationsResourceCountryOptionsDefaultStandardPlaceOfSupplyScheme::InboundGoods => "inbound_goods",
            TaxProductRegistrationsResourceCountryOptionsDefaultStandardPlaceOfSupplyScheme::Standard => "standard",
        }
    }
}

impl AsRef<str> for TaxProductRegistrationsResourceCountryOptionsDefaultStandardPlaceOfSupplyScheme {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for TaxProductRegistrationsResourceCountryOptionsDefaultStandardPlaceOfSupplyScheme {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for TaxProductRegistrationsResourceCountryOptionsDefaultStandardPlaceOfSupplyScheme {
    fn default() -> Self {
        Self::InboundGoods
    }
}
...
impl TaxProductRegistrationsResourceCountryOptionsEuStandardPlaceOfSupplyScheme {
    pub fn as_str(self) -> &'static str {
        match self {
            TaxProductRegistrationsResourceCountryOptionsEuStandardPlaceOfSupplyScheme::InboundGoods => "inbound_goods",
