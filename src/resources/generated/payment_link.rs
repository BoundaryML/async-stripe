...
use crate::resources::{
    ...
    InvoiceSettingCheckoutRenderingOptions, ShippingRate, SubscriptionsTrialsResourceTrialSettings,
    TaxId,
};
...
pub struct CreatePaymentLink<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub optional_items: Option<Vec<CreatePaymentLinkOptionalItems>>,
...
pub struct UpdatePaymentLink<'a> {
    ...
    /// We recommend that you review your privacy policy and check with your legal contacts.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub phone_number_collection: Option<UpdatePaymentLinkPhoneNumberCollection>,
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct UpdatePaymentLinkPhoneNumberCollection {
    /// Set to `true` to enable phone number collection.
    pub enabled: bool,
}
...
/// An enum representing the possible values of an `CreatePaymentLinkLineItemsPriceDataRecurring`'s `interval` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl CreatePaymentLinkLineItemsPriceDataRecurringInterval {
    pub fn as_str(self) -> &'static str {
        match self {
            CreatePaymentLinkLineItemsPriceDataRecurringInterval::Day => "day",
            CreatePaymentLinkLineItemsPriceDataRecurringInterval::Month => "month",
            CreatePaymentLinkLineItemsPriceDataRecurringInterval::Week => "week",
            CreatePaymentLinkLineItemsPriceDataRecurringInterval::Year => "year",
        }
    }
}

impl AsRef<str> for CreatePaymentLinkLineItemsPriceDataRecurringInterval {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for CreatePaymentLinkLineItemsPriceDataRecurringInterval {
    fn default() -> Self {
        Self::Day
    }
}

/// An enum representing the possible values of an `CreatePaymentLinkLineItemsPriceData`'s `tax_behavior` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl CreatePaymentLinkLineItemsPriceDataTaxBehavior {
    pub fn as_str(self) -> &'static str {
        match self {
            CreatePaymentLinkLineItemsPriceDataTaxBehavior::Exclusive => "exclusive",
            CreatePaymentLinkLineItemsPriceDataTaxBehavior::Inclusive => "inclusive",
            CreatePaymentLinkLineItemsPriceDataTaxBehavior::Unspecified => "unspecified",
        }
    }
}

impl AsRef<str> for CreatePaymentLinkLineItemsPriceDataTaxBehavior {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for CreatePaymentLinkLineItemsPriceDataTaxBehavior {
    fn default() -> Self {
        Self::Exclusive
    }
}
...
impl CreatePaymentLinkPaymentMethodTypes {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            CreatePaymentLinkPaymentMethodTypes::Alma => "alma",
            ...
            CreatePaymentLinkPaymentMethodTypes::Billie => "billie",
            ...
            CreatePaymentLinkPaymentMethodTypes::PayByBank => "pay_by_bank",
            ...
            CreatePaymentLinkPaymentMethodTypes::Satispay => "satispay",
...
impl CreatePaymentLinkShippingAddressCollectionAllowedCountries {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            CreatePaymentLinkShippingAddressCollectionAllowedCountries::Sd => "SD",
...
impl PaymentLinkPaymentMethodTypes {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            PaymentLinkPaymentMethodTypes::PayByBank => "pay_by_bank",
...
impl PaymentLinksResourceShippingAddressCollectionAllowedCountries {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            PaymentLinksResourceShippingAddressCollectionAllowedCountries::Sd => "SD",
...
impl UpdatePaymentLinkPaymentMethodTypes {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            UpdatePaymentLinkPaymentMethodTypes::Alma => "alma",
            ...
            UpdatePaymentLinkPaymentMethodTypes::Billie => "billie",
            ...
            UpdatePaymentLinkPaymentMethodTypes::PayByBank => "pay_by_bank",
            ...
            UpdatePaymentLinkPaymentMethodTypes::Satispay => "satispay",
...
impl UpdatePaymentLinkShippingAddressCollectionAllowedCountries {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            UpdatePaymentLinkShippingAddressCollectionAllowedCountries::Sd => "SD",
