...
use crate::resources::{
    ...
    PaymentMethodAcssDebit, PaymentMethodAffirm, PaymentMethodAfterpayClearpay, PaymentMethodAlma,
    PaymentMethodAmazonPay, PaymentMethodAuBecsDebit, PaymentMethodBacsDebit,
    PaymentMethodBancontact, PaymentMethodBillie, PaymentMethodBlik, PaymentMethodBoleto,
    PaymentMethodCashapp, PaymentMethodCrypto, PaymentMethodCustomerBalance, PaymentMethodEps,
    PaymentMethodFpx, PaymentMethodGiropay, PaymentMethodGrabpay, PaymentMethodIdeal,
    PaymentMethodInteracPresent, PaymentMethodKakaoPay, PaymentMethodKlarna, PaymentMethodKonbini,
    PaymentMethodKrCard, PaymentMethodLink, PaymentMethodMobilepay, PaymentMethodMultibanco,
    PaymentMethodNaverPay, PaymentMethodNzBankAccount, PaymentMethodOxxo, PaymentMethodP24,
    PaymentMethodPayByBank, PaymentMethodPayco, PaymentMethodPaynow, PaymentMethodPaypal,
    PaymentMethodPix, PaymentMethodPromptpay, PaymentMethodRevolutPay, PaymentMethodSamsungPay,
    PaymentMethodSatispay, PaymentMethodSepaDebit, PaymentMethodSofort, PaymentMethodSwish,
    PaymentMethodTwint, PaymentMethodUsBankAccount, PaymentMethodWechatPay, PaymentMethodZip,
    RadarRadarOptions,
};
...
impl PaymentMethod {
    ...
    ///
    /// A PaymentMethod must be attached to a customer to be updated.
    pub fn update(
        client: &Client,
        id: &PaymentMethodId,
...
pub struct CreatePaymentMethod<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub alma: Option<CreatePaymentMethodAlma>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub billie: Option<CreatePaymentMethodBillie>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub crypto: Option<CreatePaymentMethodCrypto>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub kakao_pay: Option<CreatePaymentMethodKakaoPay>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub kr_card: Option<CreatePaymentMethodKrCard>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub naver_pay: Option<CreatePaymentMethodNaverPay>,

    /// If this is an nz_bank_account PaymentMethod, this hash contains details about the nz_bank_account payment method.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub nz_bank_account: Option<CreatePaymentMethodNzBankAccount>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub pay_by_bank: Option<CreatePaymentMethodPayByBank>,

    /// If this is a `payco` PaymentMethod, this hash contains details about the PAYCO payment method.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub payco: Option<CreatePaymentMethodPayco>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub samsung_pay: Option<CreatePaymentMethodSamsungPay>,

    /// If this is a `satispay` PaymentMethod, this hash contains details about the Satispay payment method.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub satispay: Option<CreatePaymentMethodSatispay>,
...
pub struct UpdatePaymentMethod<'a> {
    ...
    /// If this is a `pay_by_bank` PaymentMethod, this hash contains details about the PayByBank payment method.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub pay_by_bank: Option<UpdatePaymentMethodPayByBank>,
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct CreatePaymentMethodAlma {}
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct CreatePaymentMethodBillie {}
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct CreatePaymentMethodCrypto {}
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct CreatePaymentMethodKakaoPay {}
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct CreatePaymentMethodKrCard {}
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct CreatePaymentMethodPayByBank {}

#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct CreatePaymentMethodPayco {}
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct CreatePaymentMethodSamsungPay {}

#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct CreatePaymentMethodSatispay {}
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct UpdatePaymentMethodPayByBank {}
...
impl CreatePaymentMethodIdealBank {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            CreatePaymentMethodIdealBank::Buut => "buut",
...
/// An enum representing the possible values of an `CreatePaymentMethodNaverPay`'s `funding` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl CreatePaymentMethodNaverPayFunding {
    pub fn as_str(self) -> &'static str {
        match self {
            CreatePaymentMethodNaverPayFunding::Card => "card",
            CreatePaymentMethodNaverPayFunding::Points => "points",
        }
    }
}

impl AsRef<str> for CreatePaymentMethodNaverPayFunding {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for CreatePaymentMethodNaverPayFunding {
    fn default() -> Self {
        Self::Card
    }
}
...
impl PaymentMethodTypeFilter {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            PaymentMethodTypeFilter::Alma => "alma",
            ...
            PaymentMethodTypeFilter::Billie => "billie",
            ...
            PaymentMethodTypeFilter::Crypto => "crypto",
            ...
            PaymentMethodTypeFilter::KakaoPay => "kakao_pay",
            PaymentMethodTypeFilter::Klarna => "klarna",
            PaymentMethodTypeFilter::Konbini => "konbini",
            PaymentMethodTypeFilter::KrCard => "kr_card",
            ...
            PaymentMethodTypeFilter::NaverPay => "naver_pay",
            PaymentMethodTypeFilter::NzBankAccount => "nz_bank_account",
            PaymentMethodTypeFilter::Oxxo => "oxxo",
            PaymentMethodTypeFilter::P24 => "p24",
            PaymentMethodTypeFilter::PayByBank => "pay_by_bank",
            PaymentMethodTypeFilter::Payco => "payco",
            ...
            PaymentMethodTypeFilter::SamsungPay => "samsung_pay",
            PaymentMethodTypeFilter::Satispay => "satispay",
