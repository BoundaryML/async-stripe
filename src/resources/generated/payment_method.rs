...
use crate::resources::{
    ...
    PaymentMethodCashapp, PaymentMethodCustomerBalance, PaymentMethodEps, PaymentMethodFpx,
    PaymentMethodGiropay, PaymentMethodGrabpay, PaymentMethodIdeal, PaymentMethodInteracPresent,
    PaymentMethodKakaoPay, PaymentMethodKlarna, PaymentMethodKonbini, PaymentMethodKrCard,
    PaymentMethodLink, PaymentMethodMobilepay, PaymentMethodMultibanco, PaymentMethodNaverPay,
    PaymentMethodNzBankAccount, PaymentMethodOxxo, PaymentMethodP24, PaymentMethodPayByBank,
    PaymentMethodPayco, PaymentMethodPaynow, PaymentMethodPaypal, PaymentMethodPix,
    PaymentMethodPromptpay, PaymentMethodRevolutPay, PaymentMethodSamsungPay,
