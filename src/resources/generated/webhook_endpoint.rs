...
pub enum EventFilter {
    ...
    InvoiceWillBeDue,
    #[serde(rename = "invoice_payment.paid")]
    InvoicePaymentPaid,
    ...
    #[serde(rename = "issuing_transaction.purchase_details_receipt_updated")]
    ...
    #[serde(rename = "terminal.reader.action_updated")]
...
impl EventFilter {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            EventFilter::InvoiceOverpaid => "invoice.overpaid",
            ...
            EventFilter::InvoicePaymentPaid => "invoice_payment.paid",
            ...
            EventFilter::IssuingTransactionPurchaseDetailsReceiptUpdated => {
            ...
            EventFilter::RefundFailed => "refund.failed",
            ...
            EventFilter::TerminalReaderActionUpdated => "terminal.reader.action_updated",
