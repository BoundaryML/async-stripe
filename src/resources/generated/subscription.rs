...
pub fn list(client: &Client, params: &ListSubscriptions<'_>) -> Response<List<Subscription>> {
   client.get_query("/subscriptions", params)
    ...
    /// But if the subscription is set to cancel immediately, pending prorations are removed if `invoice_now` and `prorate` are both set to true.  By default, upon subscription cancellation, Stripe stops automatic collection of all finalized invoices for the customer.
...
pub struct CreateSubscription<'a> {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub billing_mode: Option<CreateSubscriptionBillingMode>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub cancel_at: Option<Scheduled>,
...
pub struct AddInvoiceItems {
    ...
    ///
    /// Defaults to the current period of the subscription.
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl AddInvoiceItemsPeriodStartType {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            AddInvoiceItemsPeriodStartType::Now => "now",
...
/// An enum representing the possible values of an `CreateSubscriptionBillingMode`'s `type` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl CreateSubscriptionBillingModeType {
    pub fn as_str(self) -> &'static str {
        match self {
            CreateSubscriptionBillingModeType::Classic => "classic",
            CreateSubscriptionBillingModeType::Flexible => "flexible",
        }
    }
}

impl AsRef<str> for CreateSubscriptionBillingModeType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for CreateSubscriptionBillingModeType {
    fn default() -> Self {
        Self::Classic
    }
}
...
impl CreateSubscriptionPaymentSettingsPaymentMethodTypes {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            CreateSubscriptionPaymentSettingsPaymentMethodTypes::Affirm => "affirm",
            ...
            CreateSubscriptionPaymentSettingsPaymentMethodTypes::Crypto => "crypto",
            ...
            CreateSubscriptionPaymentSettingsPaymentMethodTypes::JpCreditTransfer => "jp_credit_transfer",
...
impl SubscriptionAutomaticTaxDisabledReason {
    pub fn as_str(self) -> &'static str {
        match self {
            SubscriptionAutomaticTaxDisabledReason::RequiresLocationInputs => "requires_location_inputs",
        }
    }
}
...
impl SubscriptionsResourcePaymentSettingsPaymentMethodTypes {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            SubscriptionsResourcePaymentSettingsPaymentMethodTypes::Affirm => "affirm",
            ...
            SubscriptionsResourcePaymentSettingsPaymentMethodTypes::JpCreditTransfer => "jp_credit_transfer",
...
impl UpdateSubscriptionPaymentSettingsPaymentMethodTypes {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            UpdateSubscriptionPaymentSettingsPaymentMethodTypes::Affirm => "affirm",
            ...
            UpdateSubscriptionPaymentSettingsPaymentMethodTypes::Crypto => "crypto",
            ...
            UpdateSubscriptionPaymentSettingsPaymentMethodTypes::JpCreditTransfer => "jp_credit_transfer",
