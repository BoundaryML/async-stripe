...
pub struct CreateTerminalConfigurationTipping {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub bgn: Option<CreateTerminalConfigurationTippingBgn>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub huf: Option<CreateTerminalConfigurationTippingHuf>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub mxn: Option<CreateTerminalConfigurationTippingMxn>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub ron: Option<CreateTerminalConfigurationTippingRon>,
