...
/// An enum representing the possible values of an `QuotesResourceSubscriptionDataBillingMode`'s `type` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl AsRef<str> for QuotesResourceSubscriptionDataBillingModeType {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for QuotesResourceSubscriptionDataBillingModeType {
    fn default() -> Self {
        Self::Classic
    }
}
