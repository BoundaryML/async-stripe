...
pub struct ConnectEmbeddedAccountSessionCreateComponents {
    ...
    pub balance_report: ConnectEmbeddedBaseConfigClaim,
    ...
    pub payout_reconciliation_report: ConnectEmbeddedBaseConfigClaim,
...
pub struct CreateAccountSessionComponents {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub balance_report: Option<CreateAccountSessionComponentsBalanceReport>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub payout_details: Option<CreateAccountSessionComponentsPayoutDetails>,
...
pub struct CreateAccountSessionComponentsBalanceReport {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub features: Option<CreateAccountSessionComponentsBalanceReportFeatures>,
}
...
pub struct CreateAccountSessionComponentsPayoutDetails {
    ...
    /// An empty list, because this embedded component has no features.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub features: Option<CreateAccountSessionComponentsPayoutDetailsFeatures>,
}
...
pub struct CreateAccountSessionComponentsPayoutReconciliationReport {
    ...
    /// An empty list, because this embedded component has no features.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub features: Option<CreateAccountSessionComponentsPayoutReconciliationReportFeatures>,
}
