...
pub struct PaymentIntent {
    ...
    pub excluded_payment_method_types: Option<Vec<PaymentIntentExcludedPaymentMethodTypes>>,
...
pub struct PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptions {
    ...
    /// Controls when the funds will be captured from the customer's account.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub capture_method: Option<PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptionsCaptureMethod>,
    ...
    /// If you don't provide a Customer, you can still [attach](/api/payment_methods/attach) the payment method to a Customer after the transaction completes.  If the payment method is `card_present` and isn't a digital wallet, Stripe creates and attaches a [generated_card](/api/charges/object#charge_object-payment_method_details-card_present-generated_card) payment method representing the card to the Customer instead.  When processing card payments, Stripe uses `setup_future_usage` to help you comply with regional legislation and network rules, such as [SCA](/strong-customer-authentication).
    #[serde(skip_serializing_if = "Option::is_none")]
    pub setup_future_usage: Option<PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptionsSetupFutureUsage>,
}
...
pub struct PaymentFlowsPrivatePaymentMethodsNaverPayPaymentMethodOptions {
    ...
    /// Controls when the funds will be captured from the customer's account.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub capture_method: Option<PaymentFlowsPrivatePaymentMethodsNaverPayPaymentMethodOptionsCaptureMethod>,
    ...
    /// If you don't provide a Customer, you can still [attach](/api/payment_methods/attach) the payment method to a Customer after the transaction completes.  If the payment method is `card_present` and isn't a digital wallet, Stripe creates and attaches a [generated_card](/api/charges/object#charge_object-payment_method_details-card_present-generated_card) payment method representing the card to the Customer instead.  When processing card payments, Stripe uses `setup_future_usage` to help you comply with regional legislation and network rules, such as [SCA](/strong-customer-authentication).
    #[serde(skip_serializing_if = "Option::is_none")]
    pub setup_future_usage: Option<PaymentFlowsPrivatePaymentMethodsNaverPayPaymentMethodOptionsSetupFutureUsage>,
}
...
pub struct PaymentFlowsPrivatePaymentMethodsPaycoPaymentMethodOptions {
    ...
    /// Controls when the funds will be captured from the customer's account.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub capture_method: Option<PaymentFlowsPrivatePaymentMethodsPaycoPaymentMethodOptionsCaptureMethod>,
}
...
pub struct PaymentIntentPaymentMethodOptionsNzBankAccount {
    ...
    /// If you don't provide a Customer, you can still [attach](/api/payment_methods/attach) the payment method to a Customer after the transaction completes.  If the payment method is `card_present` and isn't a digital wallet, Stripe creates and attaches a [generated_card](/api/charges/object#charge_object-payment_method_details-card_present-generated_card) payment method representing the card to the Customer instead.  When processing card payments, Stripe uses `setup_future_usage` to help you comply with regional legislation and network rules, such as [SCA](/strong-customer-authentication).
    #[serde(skip_serializing_if = "Option::is_none")]
    pub setup_future_usage: Option<PaymentIntentPaymentMethodOptionsNzBankAccountSetupFutureUsage>,
...
pub struct PaymentMethodOptionsCrypto {
    ...
    /// If you don't provide a Customer, you can still [attach](/api/payment_methods/attach) the payment method to a Customer after the transaction completes.  If the payment method is `card_present` and isn't a digital wallet, Stripe creates and attaches a [generated_card](/api/charges/object#charge_object-payment_method_details-card_present-generated_card) payment method representing the card to the Customer instead.  When processing card payments, Stripe uses `setup_future_usage` to help you comply with regional legislation and network rules, such as [SCA](/strong-customer-authentication).
    #[serde(skip_serializing_if = "Option::is_none")]
    pub setup_future_usage: Option<PaymentMethodOptionsCryptoSetupFutureUsage>,
}
...
pub struct TransferData {
    ...
    /// If no amount is specified, by default the entire payment amount is transferred to the destination account.  The amount must be less than or equal to the [amount](https://stripe.com/docs/api/payment_intents/object#payment_intent_object-amount), and must be a positive integer  representing how much to transfer in the smallest currency unit (e.g., 100 cents to charge $1.00).
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub struct CreatePaymentIntent<'a> {
    ...
    /// The list of payment method types to exclude from use with this payment.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub excluded_payment_method_types: Option<Vec<CreatePaymentIntentExcludedPaymentMethodTypes>>,
    ...
    ///
    /// We recommend that you explicitly provide the `payment_method` moving forward. If the payment method is attached to a Customer, you must also provide the ID of that Customer as the [customer](https://stripe.com/docs/api#create_payment_intent-customer) parameter of this PaymentIntent. end.
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl<'a> CreatePaymentIntent<'a> {
    pub fn new(amount: i64, currency: Currency) -> Self {
        CreatePaymentIntent {
            ...
            excluded_payment_method_types: Default::default(),
...
pub struct CreatePaymentIntentPaymentMethodData {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub alma: Option<CreatePaymentIntentPaymentMethodDataAlma>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub billie: Option<CreatePaymentIntentPaymentMethodDataBillie>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub crypto: Option<CreatePaymentIntentPaymentMethodDataCrypto>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub kakao_pay: Option<CreatePaymentIntentPaymentMethodDataKakaoPay>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub kr_card: Option<CreatePaymentIntentPaymentMethodDataKrCard>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub pay_by_bank: Option<CreatePaymentIntentPaymentMethodDataPayByBank>,

    /// If this is a `payco` PaymentMethod, this hash contains details about the PAYCO payment method.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub payco: Option<CreatePaymentIntentPaymentMethodDataPayco>,
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub samsung_pay: Option<CreatePaymentIntentPaymentMethodDataSamsungPay>,

    /// If this is a `satispay` PaymentMethod, this hash contains details about the Satispay payment method.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub satispay: Option<CreatePaymentIntentPaymentMethodDataSatispay>,
...
pub struct CreatePaymentIntentPaymentMethodOptions {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub pay_by_bank: Option<CreatePaymentIntentPaymentMethodOptionsPayByBank>,
...
pub struct UpdatePaymentIntentPaymentMethodData {
    ...
    /// If this is a Alma PaymentMethod, this hash contains details about the Alma payment method.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub alma: Option<UpdatePaymentIntentPaymentMethodDataAlma>,
    ...
    /// If this is a `billie` PaymentMethod, this hash contains details about the Billie payment method.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub billie: Option<UpdatePaymentIntentPaymentMethodDataBillie>,
    ...
    /// If this is a Crypto PaymentMethod, this hash contains details about the Crypto payment method.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub crypto: Option<UpdatePaymentIntentPaymentMethodDataCrypto>,
    ...
    /// If this is a `kakao_pay` PaymentMethod, this hash contains details about the Kakao Pay payment method.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub kakao_pay: Option<UpdatePaymentIntentPaymentMethodDataKakaoPay>,
    ...
    /// If this is a `kr_card` PaymentMethod, this hash contains details about the Korean Card payment method.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub kr_card: Option<UpdatePaymentIntentPaymentMethodDataKrCard>,
    ...
    /// If this is a `pay_by_bank` PaymentMethod, this hash contains details about the PayByBank payment method.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub pay_by_bank: Option<UpdatePaymentIntentPaymentMethodDataPayByBank>,

    /// If this is a `payco` PaymentMethod, this hash contains details about the PAYCO payment method.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub payco: Option<UpdatePaymentIntentPaymentMethodDataPayco>,
    ...
    /// If this is a `samsung_pay` PaymentMethod, this hash contains details about the SamsungPay payment method.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub samsung_pay: Option<UpdatePaymentIntentPaymentMethodDataSamsungPay>,

    /// If this is a `satispay` PaymentMethod, this hash contains details about the Satispay payment method.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub satispay: Option<UpdatePaymentIntentPaymentMethodDataSatispay>,
...
pub struct UpdatePaymentIntentPaymentMethodOptions {
    ...
    /// If this is a `pay_by_bank` PaymentMethod, this sub-hash contains details about the PayByBank payment method options.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub pay_by_bank: Option<UpdatePaymentIntentPaymentMethodOptionsPayByBank>,
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct CreatePaymentIntentPaymentMethodDataAlma {
}
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct CreatePaymentIntentPaymentMethodDataBillie {
}
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct CreatePaymentIntentPaymentMethodDataCrypto {
}
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct CreatePaymentIntentPaymentMethodDataKakaoPay {
}
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct CreatePaymentIntentPaymentMethodDataKrCard {
}
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct CreatePaymentIntentPaymentMethodDataPayByBank {
}

#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct CreatePaymentIntentPaymentMethodDataPayco {
}
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct CreatePaymentIntentPaymentMethodDataSamsungPay {
}

#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct CreatePaymentIntentPaymentMethodDataSatispay {
}
...
pub struct CreatePaymentIntentPaymentMethodOptionsNzBankAccount {
    ...
    /// If you don't provide a Customer, you can still [attach](/api/payment_methods/attach) the payment method to a Customer after the transaction completes.  If the payment method is `card_present` and isn't a digital wallet, Stripe creates and attaches a [generated_card](/api/charges/object#charge_object-payment_method_details-card_present-generated_card) payment method representing the card to the Customer instead.  When processing card payments, Stripe uses `setup_future_usage` to help you comply with regional legislation and network rules, such as [SCA](/strong-customer-authentication).  If you've already set `setup_future_usage` and you're performing a request using a publishable key, you can only update the value from `on_session` to `off_session`.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub setup_future_usage: Option<CreatePaymentIntentPaymentMethodOptionsNzBankAccountSetupFutureUsage>,
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct CreatePaymentIntentPaymentMethodOptionsPayByBank {
}
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct UpdatePaymentIntentPaymentMethodDataAlma {
}
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct UpdatePaymentIntentPaymentMethodDataBillie {
}
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct UpdatePaymentIntentPaymentMethodDataCrypto {
}
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct UpdatePaymentIntentPaymentMethodDataKakaoPay {
}
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct UpdatePaymentIntentPaymentMethodDataKrCard {
}
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct UpdatePaymentIntentPaymentMethodDataPayByBank {
}

#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct UpdatePaymentIntentPaymentMethodDataPayco {
}
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct UpdatePaymentIntentPaymentMethodDataSamsungPay {
}

#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct UpdatePaymentIntentPaymentMethodDataSatispay {
}
...
pub struct UpdatePaymentIntentPaymentMethodOptionsNzBankAccount {
    ...
    /// If you don't provide a Customer, you can still [attach](/api/payment_methods/attach) the payment method to a Customer after the transaction completes.  If the payment method is `card_present` and isn't a digital wallet, Stripe creates and attaches a [generated_card](/api/charges/object#charge_object-payment_method_details-card_present-generated_card) payment method representing the card to the Customer instead.  When processing card payments, Stripe uses `setup_future_usage` to help you comply with regional legislation and network rules, such as [SCA](/strong-customer-authentication).  If you've already set `setup_future_usage` and you're performing a request using a publishable key, you can only update the value from `on_session` to `off_session`.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub setup_future_usage: Option<UpdatePaymentIntentPaymentMethodOptionsNzBankAccountSetupFutureUsage>,
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct UpdatePaymentIntentPaymentMethodOptionsPayByBank {
}
...
pub struct CreatePaymentIntentPaymentMethodOptionsKlarnaSubscriptions {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub next_billing: Option<CreatePaymentIntentPaymentMethodOptionsKlarnaSubscriptionsNextBilling>,
...
pub struct UpdatePaymentIntentPaymentMethodOptionsKlarnaOnDemand {
    ...
    /// Interval at which the customer is making purchases.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub purchase_interval: Option<UpdatePaymentIntentPaymentMethodOptionsKlarnaOnDemandPurchaseInterval>,
...
pub struct UpdatePaymentIntentPaymentMethodOptionsKlarnaSubscriptions {
    ...
    /// Describes the upcoming charge for this subscription.
    #[serde(skip_serializing_if = "Option::is_none")]
    pub next_billing: Option<UpdatePaymentIntentPaymentMethodOptionsKlarnaSubscriptionsNextBilling>,
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct CreatePaymentIntentPaymentMethodOptionsKlarnaSubscriptionsNextBilling {
...
#[derive(Clone, Debug, Default, Deserialize, Serialize)]
pub struct UpdatePaymentIntentPaymentMethodOptionsKlarnaSubscriptionsNextBilling {
...
/// An enum representing the possible values of an `CreatePaymentIntent`'s `excluded_payment_method_types` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum CreatePaymentIntentExcludedPaymentMethodTypes {
    AcssDebit,
    Affirm,
    AfterpayClearpay,
    Alipay,
...
impl CreatePaymentIntentExcludedPaymentMethodTypes {
    pub fn as_str(self) -> &'static str {
        match self {
            CreatePaymentIntentExcludedPaymentMethodTypes::AcssDebit => "acss_debit",
            CreatePaymentIntentExcludedPaymentMethodTypes::Affirm => "affirm",
            CreatePaymentIntentExcludedPaymentMethodTypes::AfterpayClearpay => "afterpay_clearpay",
            CreatePaymentIntentExcludedPaymentMethodTypes::Alipay => "alipay",
            CreatePaymentIntentExcludedPaymentMethodTypes::Alma => "alma",
            CreatePaymentIntentExcludedPaymentMethodTypes::AmazonPay => "amazon_pay",
            CreatePaymentIntentExcludedPaymentMethodTypes::AuBecsDebit => "au_becs_debit",
            CreatePaymentIntentExcludedPaymentMethodTypes::BacsDebit => "bacs_debit",
            CreatePaymentIntentExcludedPaymentMethodTypes::Bancontact => "bancontact",
            CreatePaymentIntentExcludedPaymentMethodTypes::Billie => "billie",
            CreatePaymentIntentExcludedPaymentMethodTypes::Blik => "blik",
            CreatePaymentIntentExcludedPaymentMethodTypes::Boleto => "boleto",
            CreatePaymentIntentExcludedPaymentMethodTypes::Card => "card",
            CreatePaymentIntentExcludedPaymentMethodTypes::Cashapp => "cashapp",
            CreatePaymentIntentExcludedPaymentMethodTypes::Crypto => "crypto",
            CreatePaymentIntentExcludedPaymentMethodTypes::CustomerBalance => "customer_balance",
            CreatePaymentIntentExcludedPaymentMethodTypes::Eps => "eps",
            CreatePaymentIntentExcludedPaymentMethodTypes::Fpx => "fpx",
            CreatePaymentIntentExcludedPaymentMethodTypes::Giropay => "giropay",
            CreatePaymentIntentExcludedPaymentMethodTypes::Grabpay => "grabpay",
            CreatePaymentIntentExcludedPaymentMethodTypes::Ideal => "ideal",
            CreatePaymentIntentExcludedPaymentMethodTypes::KakaoPay => "kakao_pay",
            CreatePaymentIntentExcludedPaymentMethodTypes::Klarna => "klarna",
            CreatePaymentIntentExcludedPaymentMethodTypes::Konbini => "konbini",
            CreatePaymentIntentExcludedPaymentMethodTypes::KrCard => "kr_card",
            CreatePaymentIntentExcludedPaymentMethodTypes::Mobilepay => "mobilepay",
            CreatePaymentIntentExcludedPaymentMethodTypes::Multibanco => "multibanco",
            CreatePaymentIntentExcludedPaymentMethodTypes::NaverPay => "naver_pay",
            CreatePaymentIntentExcludedPaymentMethodTypes::NzBankAccount => "nz_bank_account",
            CreatePaymentIntentExcludedPaymentMethodTypes::Oxxo => "oxxo",
            CreatePaymentIntentExcludedPaymentMethodTypes::P24 => "p24",
            CreatePaymentIntentExcludedPaymentMethodTypes::PayByBank => "pay_by_bank",
            CreatePaymentIntentExcludedPaymentMethodTypes::Payco => "payco",
            CreatePaymentIntentExcludedPaymentMethodTypes::Paynow => "paynow",
            CreatePaymentIntentExcludedPaymentMethodTypes::Paypal => "paypal",
            CreatePaymentIntentExcludedPaymentMethodTypes::Pix => "pix",
            CreatePaymentIntentExcludedPaymentMethodTypes::Promptpay => "promptpay",
            CreatePaymentIntentExcludedPaymentMethodTypes::RevolutPay => "revolut_pay",
            CreatePaymentIntentExcludedPaymentMethodTypes::SamsungPay => "samsung_pay",
            CreatePaymentIntentExcludedPaymentMethodTypes::Satispay => "satispay",
            CreatePaymentIntentExcludedPaymentMethodTypes::SepaDebit => "sepa_debit",
            CreatePaymentIntentExcludedPaymentMethodTypes::Sofort => "sofort",
            CreatePaymentIntentExcludedPaymentMethodTypes::Swish => "swish",
            CreatePaymentIntentExcludedPaymentMethodTypes::Twint => "twint",
            CreatePaymentIntentExcludedPaymentMethodTypes::UsBankAccount => "us_bank_account",
            CreatePaymentIntentExcludedPaymentMethodTypes::WechatPay => "wechat_pay",
            CreatePaymentIntentExcludedPaymentMethodTypes::Zip => "zip",
        }
    }
}

impl AsRef<str> for CreatePaymentIntentExcludedPaymentMethodTypes {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for CreatePaymentIntentExcludedPaymentMethodTypes {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for CreatePaymentIntentExcludedPaymentMethodTypes {
    fn default() -> Self {
        Self::AcssDebit
    }
}
...
impl CreatePaymentIntentPaymentMethodDataIdealBank {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            CreatePaymentIntentPaymentMethodDataIdealBank::Buut => "buut",
...
/// An enum representing the possible values of an `CreatePaymentIntentPaymentMethodDataNaverPay`'s `funding` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl CreatePaymentIntentPaymentMethodDataNaverPayFunding {
    pub fn as_str(self) -> &'static str {
        match self {
            CreatePaymentIntentPaymentMethodDataNaverPayFunding::Card => "card",
            CreatePaymentIntentPaymentMethodDataNaverPayFunding::Points => "points",
        }
    }
}

impl AsRef<str> for CreatePaymentIntentPaymentMethodDataNaverPayFunding {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for CreatePaymentIntentPaymentMethodDataNaverPayFunding {
    fn default() -> Self {
        Self::Card
    }
}
...
impl CreatePaymentIntentPaymentMethodDataType {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            CreatePaymentIntentPaymentMethodDataType::Alma => "alma",
            ...
            CreatePaymentIntentPaymentMethodDataType::Billie => "billie",
            ...
            CreatePaymentIntentPaymentMethodDataType::Crypto => "crypto",
            ...
            CreatePaymentIntentPaymentMethodDataType::KakaoPay => "kakao_pay",
            CreatePaymentIntentPaymentMethodDataType::Klarna => "klarna",
            CreatePaymentIntentPaymentMethodDataType::Konbini => "konbini",
            CreatePaymentIntentPaymentMethodDataType::KrCard => "kr_card",
            ...
            CreatePaymentIntentPaymentMethodDataType::NaverPay => "naver_pay",
            CreatePaymentIntentPaymentMethodDataType::NzBankAccount => "nz_bank_account",
            CreatePaymentIntentPaymentMethodDataType::Oxxo => "oxxo",
            CreatePaymentIntentPaymentMethodDataType::P24 => "p24",
            CreatePaymentIntentPaymentMethodDataType::PayByBank => "pay_by_bank",
            CreatePaymentIntentPaymentMethodDataType::Payco => "payco",
            ...
            CreatePaymentIntentPaymentMethodDataType::SamsungPay => "samsung_pay",
            CreatePaymentIntentPaymentMethodDataType::Satispay => "satispay",
...
/// An enum representing the possible values of an `CreatePaymentIntentPaymentMethodOptionsAlma`'s `capture_method` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl CreatePaymentIntentPaymentMethodOptionsAlmaCaptureMethod {
    pub fn as_str(self) -> &'static str {
        match self {
            CreatePaymentIntentPaymentMethodOptionsAlmaCaptureMethod::Manual => "manual",
        }
    }
}

impl AsRef<str> for CreatePaymentIntentPaymentMethodOptionsAlmaCaptureMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for CreatePaymentIntentPaymentMethodOptionsAlmaCaptureMethod {
    fn default() -> Self {
        Self::Manual
    }
}
...
/// An enum representing the possible values of an `CreatePaymentIntentPaymentMethodOptionsBillie`'s `capture_method` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl CreatePaymentIntentPaymentMethodOptionsBillieCaptureMethod {
    pub fn as_str(self) -> &'static str {
        match self {
            CreatePaymentIntentPaymentMethodOptionsBillieCaptureMethod::Manual => "manual",
        }
    }
}

impl AsRef<str> for CreatePaymentIntentPaymentMethodOptionsBillieCaptureMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for CreatePaymentIntentPaymentMethodOptionsBillieCaptureMethod {
    fn default() -> Self {
        Self::Manual
    }
}
...
impl CreatePaymentIntentPaymentMethodOptionsCardInstallmentsPlanType {
    pub fn as_str(self) -> &'static str {
        match self {
            CreatePaymentIntentPaymentMethodOptionsCardInstallmentsPlanType::Bonus => "bonus",
            CreatePaymentIntentPaymentMethodOptionsCardInstallmentsPlanType::FixedCount => "fixed_count",
            CreatePaymentIntentPaymentMethodOptionsCardInstallmentsPlanType::Revolving => "revolving",
        }
    }
}
...
impl CreatePaymentIntentPaymentMethodOptionsCardNetwork {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            CreatePaymentIntentPaymentMethodOptionsCardNetwork::Link => "link",
...
/// An enum representing the possible values of an `CreatePaymentIntentPaymentMethodOptionsCrypto`'s `setup_future_usage` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl CreatePaymentIntentPaymentMethodOptionsCryptoSetupFutureUsage {
    pub fn as_str(self) -> &'static str {
        match self {
            CreatePaymentIntentPaymentMethodOptionsCryptoSetupFutureUsage::None => "none",
        }
    }
}

impl AsRef<str> for CreatePaymentIntentPaymentMethodOptionsCryptoSetupFutureUsage {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for CreatePaymentIntentPaymentMethodOptionsCryptoSetupFutureUsage {
    fn default() -> Self {
        Self::None
    }
}
...
/// An enum representing the possible values of an `CreatePaymentIntentPaymentMethodOptionsKakaoPay`'s `capture_method` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl CreatePaymentIntentPaymentMethodOptionsKakaoPayCaptureMethod {
    pub fn as_str(self) -> &'static str {
        match self {
            CreatePaymentIntentPaymentMethodOptionsKakaoPayCaptureMethod::Manual => "manual",
        }
    }
}

impl AsRef<str> for CreatePaymentIntentPaymentMethodOptionsKakaoPayCaptureMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for CreatePaymentIntentPaymentMethodOptionsKakaoPayCaptureMethod {
    fn default() -> Self {
        Self::Manual
    }
}

/// An enum representing the possible values of an `CreatePaymentIntentPaymentMethodOptionsKakaoPay`'s `setup_future_usage` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl CreatePaymentIntentPaymentMethodOptionsKakaoPaySetupFutureUsage {
    pub fn as_str(self) -> &'static str {
        match self {
            CreatePaymentIntentPaymentMethodOptionsKakaoPaySetupFutureUsage::None => "none",
            CreatePaymentIntentPaymentMethodOptionsKakaoPaySetupFutureUsage::OffSession => "off_session",
        }
    }
}

impl AsRef<str> for CreatePaymentIntentPaymentMethodOptionsKakaoPaySetupFutureUsage {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for CreatePaymentIntentPaymentMethodOptionsKakaoPaySetupFutureUsage {
    fn default() -> Self {
        Self::None
    }
}
...
/// An enum representing the possible values of an `CreatePaymentIntentPaymentMethodOptionsKlarnaOnDemand`'s `purchase_interval` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl CreatePaymentIntentPaymentMethodOptionsKlarnaOnDemandPurchaseInterval {
    pub fn as_str(self) -> &'static str {
        match self {
            CreatePaymentIntentPaymentMethodOptionsKlarnaOnDemandPurchaseInterval::Day => "day",
            CreatePaymentIntentPaymentMethodOptionsKlarnaOnDemandPurchaseInterval::Month => "month",
            CreatePaymentIntentPaymentMethodOptionsKlarnaOnDemandPurchaseInterval::Week => "week",
            CreatePaymentIntentPaymentMethodOptionsKlarnaOnDemandPurchaseInterval::Year => "year",
        }
    }
}

impl AsRef<str> for CreatePaymentIntentPaymentMethodOptionsKlarnaOnDemandPurchaseInterval {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for CreatePaymentIntentPaymentMethodOptionsKlarnaOnDemandPurchaseInterval {
    fn default() -> Self {
        Self::Day
    }
}
...
impl CreatePaymentIntentPaymentMethodOptionsKlarnaSetupFutureUsage {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            CreatePaymentIntentPaymentMethodOptionsKlarnaSetupFutureUsage::OffSession => "off_session",
            CreatePaymentIntentPaymentMethodOptionsKlarnaSetupFutureUsage::OnSession => "on_session",
        }
    }
}
...
/// An enum representing the possible values of an `CreatePaymentIntentPaymentMethodOptionsKlarnaSubscriptions`'s `interval` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl CreatePaymentIntentPaymentMethodOptionsKlarnaSubscriptionsInterval {
    pub fn as_str(self) -> &'static str {
        match self {
            CreatePaymentIntentPaymentMethodOptionsKlarnaSubscriptionsInterval::Day => "day",
            CreatePaymentIntentPaymentMethodOptionsKlarnaSubscriptionsInterval::Month => "month",
            CreatePaymentIntentPaymentMethodOptionsKlarnaSubscriptionsInterval::Week => "week",
            CreatePaymentIntentPaymentMethodOptionsKlarnaSubscriptionsInterval::Year => "year",
        }
    }
}

impl AsRef<str> for CreatePaymentIntentPaymentMethodOptionsKlarnaSubscriptionsInterval {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for CreatePaymentIntentPaymentMethodOptionsKlarnaSubscriptionsInterval {
    fn default() -> Self {
        Self::Day
    }
}
...
/// An enum representing the possible values of an `CreatePaymentIntentPaymentMethodOptionsKrCard`'s `capture_method` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl CreatePaymentIntentPaymentMethodOptionsKrCardCaptureMethod {
    pub fn as_str(self) -> &'static str {
        match self {
            CreatePaymentIntentPaymentMethodOptionsKrCardCaptureMethod::Manual => "manual",
        }
    }
}

impl AsRef<str> for CreatePaymentIntentPaymentMethodOptionsKrCardCaptureMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for CreatePaymentIntentPaymentMethodOptionsKrCardCaptureMethod {
    fn default() -> Self {
        Self::Manual
    }
}

/// An enum representing the possible values of an `CreatePaymentIntentPaymentMethodOptionsKrCard`'s `setup_future_usage` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl CreatePaymentIntentPaymentMethodOptionsKrCardSetupFutureUsage {
    pub fn as_str(self) -> &'static str {
        match self {
            CreatePaymentIntentPaymentMethodOptionsKrCardSetupFutureUsage::None => "none",
            CreatePaymentIntentPaymentMethodOptionsKrCardSetupFutureUsage::OffSession => "off_session",
        }
    }
}

impl AsRef<str> for CreatePaymentIntentPaymentMethodOptionsKrCardSetupFutureUsage {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for CreatePaymentIntentPaymentMethodOptionsKrCardSetupFutureUsage {
    fn default() -> Self {
        Self::None
    }
}
...
/// An enum representing the possible values of an `CreatePaymentIntentPaymentMethodOptionsNaverPay`'s `capture_method` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl CreatePaymentIntentPaymentMethodOptionsNaverPayCaptureMethod {
    pub fn as_str(self) -> &'static str {
        match self {
            CreatePaymentIntentPaymentMethodOptionsNaverPayCaptureMethod::Manual => "manual",
        }
    }
}

impl AsRef<str> for CreatePaymentIntentPaymentMethodOptionsNaverPayCaptureMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for CreatePaymentIntentPaymentMethodOptionsNaverPayCaptureMethod {
    fn default() -> Self {
        Self::Manual
    }
}

/// An enum representing the possible values of an `CreatePaymentIntentPaymentMethodOptionsNaverPay`'s `setup_future_usage` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl CreatePaymentIntentPaymentMethodOptionsNaverPaySetupFutureUsage {
    pub fn as_str(self) -> &'static str {
        match self {
            CreatePaymentIntentPaymentMethodOptionsNaverPaySetupFutureUsage::None => "none",
            CreatePaymentIntentPaymentMethodOptionsNaverPaySetupFutureUsage::OffSession => "off_session",
        }
    }
}

impl AsRef<str> for CreatePaymentIntentPaymentMethodOptionsNaverPaySetupFutureUsage {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for CreatePaymentIntentPaymentMethodOptionsNaverPaySetupFutureUsage {
    fn default() -> Self {
        Self::None
    }
}

/// An enum representing the possible values of an `CreatePaymentIntentPaymentMethodOptionsNzBankAccount`'s `setup_future_usage` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl CreatePaymentIntentPaymentMethodOptionsNzBankAccountSetupFutureUsage {
    pub fn as_str(self) -> &'static str {
        match self {
            CreatePaymentIntentPaymentMethodOptionsNzBankAccountSetupFutureUsage::None => "none",
            CreatePaymentIntentPaymentMethodOptionsNzBankAccountSetupFutureUsage::OffSession => "off_session",
            CreatePaymentIntentPaymentMethodOptionsNzBankAccountSetupFutureUsage::OnSession => "on_session",
        }
    }
}

impl AsRef<str> for CreatePaymentIntentPaymentMethodOptionsNzBankAccountSetupFutureUsage {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for CreatePaymentIntentPaymentMethodOptionsNzBankAccountSetupFutureUsage {
    fn default() -> Self {
        Self::None
    }
}
...
/// An enum representing the possible values of an `CreatePaymentIntentPaymentMethodOptionsPayco`'s `capture_method` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl CreatePaymentIntentPaymentMethodOptionsPaycoCaptureMethod {
    pub fn as_str(self) -> &'static str {
        match self {
            CreatePaymentIntentPaymentMethodOptionsPaycoCaptureMethod::Manual => "manual",
        }
    }
}

impl AsRef<str> for CreatePaymentIntentPaymentMethodOptionsPaycoCaptureMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for CreatePaymentIntentPaymentMethodOptionsPaycoCaptureMethod {
    fn default() -> Self {
        Self::Manual
    }
}
...
/// An enum representing the possible values of an `CreatePaymentIntentPaymentMethodOptionsPix`'s `amount_includes_iof` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl CreatePaymentIntentPaymentMethodOptionsPixAmountIncludesIof {
    pub fn as_str(self) -> &'static str {
        match self {
            CreatePaymentIntentPaymentMethodOptionsPixAmountIncludesIof::Always => "always",
            CreatePaymentIntentPaymentMethodOptionsPixAmountIncludesIof::Never => "never",
        }
    }
}

impl AsRef<str> for CreatePaymentIntentPaymentMethodOptionsPixAmountIncludesIof {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for CreatePaymentIntentPaymentMethodOptionsPixAmountIncludesIof {
    fn default() -> Self {
        Self::Always
    }
}
...
/// An enum representing the possible values of an `CreatePaymentIntentPaymentMethodOptionsSamsungPay`'s `capture_method` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl CreatePaymentIntentPaymentMethodOptionsSamsungPayCaptureMethod {
    pub fn as_str(self) -> &'static str {
        match self {
            CreatePaymentIntentPaymentMethodOptionsSamsungPayCaptureMethod::Manual => "manual",
        }
    }
}

impl AsRef<str> for CreatePaymentIntentPaymentMethodOptionsSamsungPayCaptureMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for CreatePaymentIntentPaymentMethodOptionsSamsungPayCaptureMethod {
    fn default() -> Self {
        Self::Manual
    }
}

/// An enum representing the possible values of an `CreatePaymentIntentPaymentMethodOptionsSatispay`'s `capture_method` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl CreatePaymentIntentPaymentMethodOptionsSatispayCaptureMethod {
    pub fn as_str(self) -> &'static str {
        match self {
            CreatePaymentIntentPaymentMethodOptionsSatispayCaptureMethod::Manual => "manual",
        }
    }
}

impl AsRef<str> for CreatePaymentIntentPaymentMethodOptionsSatispayCaptureMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for CreatePaymentIntentPaymentMethodOptionsSatispayCaptureMethod {
    fn default() -> Self {
        Self::Manual
    }
}
...
/// An enum representing the possible values of an `PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptions`'s `capture_method` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptionsCaptureMethod {
    pub fn as_str(self) -> &'static str {
        match self {
            PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptionsCaptureMethod::Manual => "manual",
        }
    }
}

impl AsRef<str> for PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptionsCaptureMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptionsCaptureMethod {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptionsCaptureMethod {
    fn default() -> Self {
        Self::Manual
    }
}

/// An enum representing the possible values of an `PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptions`'s `setup_future_usage` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptionsSetupFutureUsage {
    pub fn as_str(self) -> &'static str {
        match self {
            PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptionsSetupFutureUsage::None => "none",
            PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptionsSetupFutureUsage::OffSession => "off_session",
        }
    }
}

impl AsRef<str> for PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptionsSetupFutureUsage {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptionsSetupFutureUsage {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for PaymentFlowsPrivatePaymentMethodsKakaoPayPaymentMethodOptionsSetupFutureUsage {
    fn default() -> Self {
        Self::None
    }
}

/// An enum representing the possible values of an `PaymentFlowsPrivatePaymentMethodsNaverPayPaymentMethodOptions`'s `capture_method` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl PaymentFlowsPrivatePaymentMethodsNaverPayPaymentMethodOptionsCaptureMethod {
    pub fn as_str(self) -> &'static str {
        match self {
            PaymentFlowsPrivatePaymentMethodsNaverPayPaymentMethodOptionsCaptureMethod::Manual => "manual",
        }
    }
}

impl AsRef<str> for PaymentFlowsPrivatePaymentMethodsNaverPayPaymentMethodOptionsCaptureMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for PaymentFlowsPrivatePaymentMethodsNaverPayPaymentMethodOptionsCaptureMethod {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for PaymentFlowsPrivatePaymentMethodsNaverPayPaymentMethodOptionsCaptureMethod {
    fn default() -> Self {
        Self::Manual
    }
}

/// An enum representing the possible values of an `PaymentFlowsPrivatePaymentMethodsNaverPayPaymentMethodOptions`'s `setup_future_usage` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl PaymentFlowsPrivatePaymentMethodsNaverPayPaymentMethodOptionsSetupFutureUsage {
    pub fn as_str(self) -> &'static str {
        match self {
            PaymentFlowsPrivatePaymentMethodsNaverPayPaymentMethodOptionsSetupFutureUsage::None => "none",
            PaymentFlowsPrivatePaymentMethodsNaverPayPaymentMethodOptionsSetupFutureUsage::OffSession => "off_session",
        }
    }
}

impl AsRef<str> for PaymentFlowsPrivatePaymentMethodsNaverPayPaymentMethodOptionsSetupFutureUsage {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for PaymentFlowsPrivatePaymentMethodsNaverPayPaymentMethodOptionsSetupFutureUsage {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for PaymentFlowsPrivatePaymentMethodsNaverPayPaymentMethodOptionsSetupFutureUsage {
    fn default() -> Self {
        Self::None
    }
}

/// An enum representing the possible values of an `PaymentFlowsPrivatePaymentMethodsPaycoPaymentMethodOptions`'s `capture_method` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl PaymentFlowsPrivatePaymentMethodsPaycoPaymentMethodOptionsCaptureMethod {
    pub fn as_str(self) -> &'static str {
        match self {
            PaymentFlowsPrivatePaymentMethodsPaycoPaymentMethodOptionsCaptureMethod::Manual => "manual",
        }
    }
}

impl AsRef<str> for PaymentFlowsPrivatePaymentMethodsPaycoPaymentMethodOptionsCaptureMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for PaymentFlowsPrivatePaymentMethodsPaycoPaymentMethodOptionsCaptureMethod {
    fn default() -> Self {
        Self::Manual
    }
}

/// An enum representing the possible values of an `PaymentFlowsPrivatePaymentMethodsSamsungPayPaymentMethodOptions`'s `capture_method` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl PaymentFlowsPrivatePaymentMethodsSamsungPayPaymentMethodOptionsCaptureMethod {
    pub fn as_str(self) -> &'static str {
        match self {
            PaymentFlowsPrivatePaymentMethodsSamsungPayPaymentMethodOptionsCaptureMethod::Manual => "manual",
        }
    }
}

impl AsRef<str> for PaymentFlowsPrivatePaymentMethodsSamsungPayPaymentMethodOptionsCaptureMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for PaymentFlowsPrivatePaymentMethodsSamsungPayPaymentMethodOptionsCaptureMethod {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for PaymentFlowsPrivatePaymentMethodsSamsungPayPaymentMethodOptionsCaptureMethod {
    fn default() -> Self {
        Self::Manual
    }
}
...
/// An enum representing the possible values of an `PaymentIntent`'s `excluded_payment_method_types` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl PaymentIntentExcludedPaymentMethodTypes {
    pub fn as_str(self) -> &'static str {
        match self {
            PaymentIntentExcludedPaymentMethodTypes::AcssDebit => "acss_debit",
            PaymentIntentExcludedPaymentMethodTypes::Affirm => "affirm",
            PaymentIntentExcludedPaymentMethodTypes::AfterpayClearpay => "afterpay_clearpay",
            PaymentIntentExcludedPaymentMethodTypes::Alipay => "alipay",
            PaymentIntentExcludedPaymentMethodTypes::Alma => "alma",
            PaymentIntentExcludedPaymentMethodTypes::AmazonPay => "amazon_pay",
            PaymentIntentExcludedPaymentMethodTypes::AuBecsDebit => "au_becs_debit",
            PaymentIntentExcludedPaymentMethodTypes::BacsDebit => "bacs_debit",
            PaymentIntentExcludedPaymentMethodTypes::Bancontact => "bancontact",
            PaymentIntentExcludedPaymentMethodTypes::Billie => "billie",
            PaymentIntentExcludedPaymentMethodTypes::Blik => "blik",
            PaymentIntentExcludedPaymentMethodTypes::Boleto => "boleto",
            PaymentIntentExcludedPaymentMethodTypes::Card => "card",
            PaymentIntentExcludedPaymentMethodTypes::Cashapp => "cashapp",
            PaymentIntentExcludedPaymentMethodTypes::Crypto => "crypto",
            PaymentIntentExcludedPaymentMethodTypes::CustomerBalance => "customer_balance",
            PaymentIntentExcludedPaymentMethodTypes::Eps => "eps",
            PaymentIntentExcludedPaymentMethodTypes::Fpx => "fpx",
            PaymentIntentExcludedPaymentMethodTypes::Giropay => "giropay",
            PaymentIntentExcludedPaymentMethodTypes::Grabpay => "grabpay",
            PaymentIntentExcludedPaymentMethodTypes::Ideal => "ideal",
            PaymentIntentExcludedPaymentMethodTypes::KakaoPay => "kakao_pay",
            PaymentIntentExcludedPaymentMethodTypes::Klarna => "klarna",
            PaymentIntentExcludedPaymentMethodTypes::Konbini => "konbini",
            PaymentIntentExcludedPaymentMethodTypes::KrCard => "kr_card",
            PaymentIntentExcludedPaymentMethodTypes::Mobilepay => "mobilepay",
            PaymentIntentExcludedPaymentMethodTypes::Multibanco => "multibanco",
            PaymentIntentExcludedPaymentMethodTypes::NaverPay => "naver_pay",
            PaymentIntentExcludedPaymentMethodTypes::NzBankAccount => "nz_bank_account",
            PaymentIntentExcludedPaymentMethodTypes::Oxxo => "oxxo",
            PaymentIntentExcludedPaymentMethodTypes::P24 => "p24",
            PaymentIntentExcludedPaymentMethodTypes::PayByBank => "pay_by_bank",
            PaymentIntentExcludedPaymentMethodTypes::Payco => "payco",
            PaymentIntentExcludedPaymentMethodTypes::Paynow => "paynow",
            PaymentIntentExcludedPaymentMethodTypes::Paypal => "paypal",
            PaymentIntentExcludedPaymentMethodTypes::Pix => "pix",
            PaymentIntentExcludedPaymentMethodTypes::Promptpay => "promptpay",
            PaymentIntentExcludedPaymentMethodTypes::RevolutPay => "revolut_pay",
            PaymentIntentExcludedPaymentMethodTypes::SamsungPay => "samsung_pay",
            PaymentIntentExcludedPaymentMethodTypes::Satispay => "satispay",
            PaymentIntentExcludedPaymentMethodTypes::SepaDebit => "sepa_debit",
            PaymentIntentExcludedPaymentMethodTypes::Sofort => "sofort",
            PaymentIntentExcludedPaymentMethodTypes::Swish => "swish",
            PaymentIntentExcludedPaymentMethodTypes::Twint => "twint",
            PaymentIntentExcludedPaymentMethodTypes::UsBankAccount => "us_bank_account",
            PaymentIntentExcludedPaymentMethodTypes::WechatPay => "wechat_pay",
            PaymentIntentExcludedPaymentMethodTypes::Zip => "zip",
        }
    }
}

impl AsRef<str> for PaymentIntentExcludedPaymentMethodTypes {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for PaymentIntentExcludedPaymentMethodTypes {
    fn default() -> Self {
        Self::AcssDebit
    }
}
...
/// An enum representing the possible values of an `PaymentIntentPaymentMethodOptionsNzBankAccount`'s `setup_future_usage` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum PaymentIntentPaymentMethodOptionsNzBankAccountSetupFutureUsage {
    None,
    OffSession,
    OnSession,
}

impl PaymentIntentPaymentMethodOptionsNzBankAccountSetupFutureUsage {
    pub fn as_str(self) -> &'static str {
        match self {
            PaymentIntentPaymentMethodOptionsNzBankAccountSetupFutureUsage::None => "none",
            PaymentIntentPaymentMethodOptionsNzBankAccountSetupFutureUsage::OffSession => "off_session",
            PaymentIntentPaymentMethodOptionsNzBankAccountSetupFutureUsage::OnSession => "on_session",
        }
    }
}

impl AsRef<str> for PaymentIntentPaymentMethodOptionsNzBankAccountSetupFutureUsage {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for PaymentIntentPaymentMethodOptionsNzBankAccountSetupFutureUsage {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for PaymentIntentPaymentMethodOptionsNzBankAccountSetupFutureUsage {
    fn default() -> Self {
        Self::None
    }
}
...
/// An enum representing the possible values of an `PaymentMethodOptionsAlma`'s `capture_method` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl PaymentMethodOptionsAlmaCaptureMethod {
    pub fn as_str(self) -> &'static str {
        match self {
            PaymentMethodOptionsAlmaCaptureMethod::Manual => "manual",
        }
    }
}

impl AsRef<str> for PaymentMethodOptionsAlmaCaptureMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for PaymentMethodOptionsAlmaCaptureMethod {
    fn default() -> Self {
        Self::Manual
    }
}
...
/// An enum representing the possible values of an `PaymentMethodOptionsBillie`'s `capture_method` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl PaymentMethodOptionsBillieCaptureMethod {
    pub fn as_str(self) -> &'static str {
        match self {
            PaymentMethodOptionsBillieCaptureMethod::Manual => "manual",
        }
    }
}

impl AsRef<str> for PaymentMethodOptionsBillieCaptureMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for PaymentMethodOptionsBillieCaptureMethod {
    fn default() -> Self {
        Self::Manual
    }
}
...
/// An enum representing the possible values of an `PaymentMethodOptionsCrypto`'s `setup_future_usage` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum PaymentMethodOptionsCryptoSetupFutureUsage {
    None,
}

impl PaymentMethodOptionsCryptoSetupFutureUsage {
    pub fn as_str(self) -> &'static str {
        match self {
            PaymentMethodOptionsCryptoSetupFutureUsage::None => "none",
        }
    }
}

impl AsRef<str> for PaymentMethodOptionsCryptoSetupFutureUsage {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for PaymentMethodOptionsCryptoSetupFutureUsage {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for PaymentMethodOptionsCryptoSetupFutureUsage {
    fn default() -> Self {
        Self::None
    }
}
...
impl PaymentMethodOptionsKlarnaSetupFutureUsage {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            PaymentMethodOptionsKlarnaSetupFutureUsage::OffSession => "off_session",
            PaymentMethodOptionsKlarnaSetupFutureUsage::OnSession => "on_session",
        }
    }
}
...
/// An enum representing the possible values of an `PaymentMethodOptionsKrCard`'s `capture_method` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl PaymentMethodOptionsKrCardCaptureMethod {
    pub fn as_str(self) -> &'static str {
        match self {
            PaymentMethodOptionsKrCardCaptureMethod::Manual => "manual",
        }
    }
}

impl AsRef<str> for PaymentMethodOptionsKrCardCaptureMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for PaymentMethodOptionsKrCardCaptureMethod {
    fn default() -> Self {
        Self::Manual
    }
}

/// An enum representing the possible values of an `PaymentMethodOptionsKrCard`'s `setup_future_usage` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl PaymentMethodOptionsKrCardSetupFutureUsage {
    pub fn as_str(self) -> &'static str {
        match self {
            PaymentMethodOptionsKrCardSetupFutureUsage::None => "none",
            PaymentMethodOptionsKrCardSetupFutureUsage::OffSession => "off_session",
        }
    }
}

impl AsRef<str> for PaymentMethodOptionsKrCardSetupFutureUsage {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for PaymentMethodOptionsKrCardSetupFutureUsage {
    fn default() -> Self {
        Self::None
    }
}
...
/// An enum representing the possible values of an `PaymentMethodOptionsPix`'s `amount_includes_iof` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl PaymentMethodOptionsPixAmountIncludesIof {
    pub fn as_str(self) -> &'static str {
        match self {
            PaymentMethodOptionsPixAmountIncludesIof::Always => "always",
            PaymentMethodOptionsPixAmountIncludesIof::Never => "never",
        }
    }
}

impl AsRef<str> for PaymentMethodOptionsPixAmountIncludesIof {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for PaymentMethodOptionsPixAmountIncludesIof {
    fn default() -> Self {
        Self::Always
    }
}
...
/// An enum representing the possible values of an `PaymentMethodOptionsSatispay`'s `capture_method` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
pub enum PaymentMethodOptionsSatispayCaptureMethod {
    Manual,
}

impl PaymentMethodOptionsSatispayCaptureMethod {
    pub fn as_str(self) -> &'static str {
        match self {
            PaymentMethodOptionsSatispayCaptureMethod::Manual => "manual",
        }
    }
}

impl AsRef<str> for PaymentMethodOptionsSatispayCaptureMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}

impl std::fmt::Display for PaymentMethodOptionsSatispayCaptureMethod {
    fn fmt(&self, f: &mut std::fmt::Formatter) -> std::fmt::Result {
        self.as_str().fmt(f)
    }
}
impl std::default::Default for PaymentMethodOptionsSatispayCaptureMethod {
    fn default() -> Self {
        Self::Manual
    }
}
...
impl UpdatePaymentIntentPaymentMethodDataIdealBank {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            UpdatePaymentIntentPaymentMethodDataIdealBank::Buut => "buut",
...
/// An enum representing the possible values of an `UpdatePaymentIntentPaymentMethodDataNaverPay`'s `funding` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl UpdatePaymentIntentPaymentMethodDataNaverPayFunding {
    pub fn as_str(self) -> &'static str {
        match self {
            UpdatePaymentIntentPaymentMethodDataNaverPayFunding::Card => "card",
            UpdatePaymentIntentPaymentMethodDataNaverPayFunding::Points => "points",
        }
    }
}

impl AsRef<str> for UpdatePaymentIntentPaymentMethodDataNaverPayFunding {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for UpdatePaymentIntentPaymentMethodDataNaverPayFunding {
    fn default() -> Self {
        Self::Card
    }
}
...
impl UpdatePaymentIntentPaymentMethodDataType {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            UpdatePaymentIntentPaymentMethodDataType::Alma => "alma",
            ...
            UpdatePaymentIntentPaymentMethodDataType::Billie => "billie",
            ...
            UpdatePaymentIntentPaymentMethodDataType::Crypto => "crypto",
            ...
            UpdatePaymentIntentPaymentMethodDataType::KakaoPay => "kakao_pay",
            UpdatePaymentIntentPaymentMethodDataType::Klarna => "klarna",
            UpdatePaymentIntentPaymentMethodDataType::Konbini => "konbini",
            UpdatePaymentIntentPaymentMethodDataType::KrCard => "kr_card",
            ...
            UpdatePaymentIntentPaymentMethodDataType::NaverPay => "naver_pay",
            UpdatePaymentIntentPaymentMethodDataType::NzBankAccount => "nz_bank_account",
            UpdatePaymentIntentPaymentMethodDataType::Oxxo => "oxxo",
            UpdatePaymentIntentPaymentMethodDataType::P24 => "p24",
            UpdatePaymentIntentPaymentMethodDataType::PayByBank => "pay_by_bank",
            UpdatePaymentIntentPaymentMethodDataType::Payco => "payco",
            ...
            UpdatePaymentIntentPaymentMethodDataType::SamsungPay => "samsung_pay",
            UpdatePaymentIntentPaymentMethodDataType::Satispay => "satispay",
...
/// An enum representing the possible values of an `UpdatePaymentIntentPaymentMethodOptionsAlma`'s `capture_method` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl UpdatePaymentIntentPaymentMethodOptionsAlmaCaptureMethod {
    pub fn as_str(self) -> &'static str {
        match self {
            UpdatePaymentIntentPaymentMethodOptionsAlmaCaptureMethod::Manual => "manual",
        }
    }
}

impl AsRef<str> for UpdatePaymentIntentPaymentMethodOptionsAlmaCaptureMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for UpdatePaymentIntentPaymentMethodOptionsAlmaCaptureMethod {
    fn default() -> Self {
        Self::Manual
    }
}
...
/// An enum representing the possible values of an `UpdatePaymentIntentPaymentMethodOptionsBillie`'s `capture_method` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl UpdatePaymentIntentPaymentMethodOptionsBillieCaptureMethod {
    pub fn as_str(self) -> &'static str {
        match self {
            UpdatePaymentIntentPaymentMethodOptionsBillieCaptureMethod::Manual => "manual",
        }
    }
}

impl AsRef<str> for UpdatePaymentIntentPaymentMethodOptionsBillieCaptureMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for UpdatePaymentIntentPaymentMethodOptionsBillieCaptureMethod {
    fn default() -> Self {
        Self::Manual
    }
}
...
impl UpdatePaymentIntentPaymentMethodOptionsCardInstallmentsPlanType {
    pub fn as_str(self) -> &'static str {
        match self {
            UpdatePaymentIntentPaymentMethodOptionsCardInstallmentsPlanType::Bonus => "bonus",
            UpdatePaymentIntentPaymentMethodOptionsCardInstallmentsPlanType::FixedCount => "fixed_count",
            UpdatePaymentIntentPaymentMethodOptionsCardInstallmentsPlanType::Revolving => "revolving",
        }
    }
}
...
impl UpdatePaymentIntentPaymentMethodOptionsCardNetwork {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            UpdatePaymentIntentPaymentMethodOptionsCardNetwork::Link => "link",
...
/// An enum representing the possible values of an `UpdatePaymentIntentPaymentMethodOptionsCrypto`'s `setup_future_usage` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl UpdatePaymentIntentPaymentMethodOptionsCryptoSetupFutureUsage {
    pub fn as_str(self) -> &'static str {
        match self {
            UpdatePaymentIntentPaymentMethodOptionsCryptoSetupFutureUsage::None => "none",
        }
    }
}

impl AsRef<str> for UpdatePaymentIntentPaymentMethodOptionsCryptoSetupFutureUsage {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for UpdatePaymentIntentPaymentMethodOptionsCryptoSetupFutureUsage {
    fn default() -> Self {
        Self::None
    }
}
...
/// An enum representing the possible values of an `UpdatePaymentIntentPaymentMethodOptionsKakaoPay`'s `capture_method` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl UpdatePaymentIntentPaymentMethodOptionsKakaoPayCaptureMethod {
    pub fn as_str(self) -> &'static str {
        match self {
            UpdatePaymentIntentPaymentMethodOptionsKakaoPayCaptureMethod::Manual => "manual",
        }
    }
}

impl AsRef<str> for UpdatePaymentIntentPaymentMethodOptionsKakaoPayCaptureMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for UpdatePaymentIntentPaymentMethodOptionsKakaoPayCaptureMethod {
    fn default() -> Self {
        Self::Manual
    }
}

/// An enum representing the possible values of an `UpdatePaymentIntentPaymentMethodOptionsKakaoPay`'s `setup_future_usage` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl UpdatePaymentIntentPaymentMethodOptionsKakaoPaySetupFutureUsage {
    pub fn as_str(self) -> &'static str {
        match self {
            UpdatePaymentIntentPaymentMethodOptionsKakaoPaySetupFutureUsage::None => "none",
            UpdatePaymentIntentPaymentMethodOptionsKakaoPaySetupFutureUsage::OffSession => "off_session",
        }
    }
}

impl AsRef<str> for UpdatePaymentIntentPaymentMethodOptionsKakaoPaySetupFutureUsage {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for UpdatePaymentIntentPaymentMethodOptionsKakaoPaySetupFutureUsage {
    fn default() -> Self {
        Self::None
    }
}
...
/// An enum representing the possible values of an `UpdatePaymentIntentPaymentMethodOptionsKlarnaOnDemand`'s `purchase_interval` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl UpdatePaymentIntentPaymentMethodOptionsKlarnaOnDemandPurchaseInterval {
    pub fn as_str(self) -> &'static str {
        match self {
            UpdatePaymentIntentPaymentMethodOptionsKlarnaOnDemandPurchaseInterval::Day => "day",
            UpdatePaymentIntentPaymentMethodOptionsKlarnaOnDemandPurchaseInterval::Month => "month",
            UpdatePaymentIntentPaymentMethodOptionsKlarnaOnDemandPurchaseInterval::Week => "week",
            UpdatePaymentIntentPaymentMethodOptionsKlarnaOnDemandPurchaseInterval::Year => "year",
        }
    }
}

impl AsRef<str> for UpdatePaymentIntentPaymentMethodOptionsKlarnaOnDemandPurchaseInterval {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for UpdatePaymentIntentPaymentMethodOptionsKlarnaOnDemandPurchaseInterval {
    fn default() -> Self {
        Self::Day
    }
}
...
impl UpdatePaymentIntentPaymentMethodOptionsKlarnaSetupFutureUsage {
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            UpdatePaymentIntentPaymentMethodOptionsKlarnaSetupFutureUsage::OffSession => "off_session",
            UpdatePaymentIntentPaymentMethodOptionsKlarnaSetupFutureUsage::OnSession => "on_session",
        }
    }
}
...
/// An enum representing the possible values of an `UpdatePaymentIntentPaymentMethodOptionsKlarnaSubscriptions`'s `interval` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl UpdatePaymentIntentPaymentMethodOptionsKlarnaSubscriptionsInterval {
    pub fn as_str(self) -> &'static str {
        match self {
            UpdatePaymentIntentPaymentMethodOptionsKlarnaSubscriptionsInterval::Day => "day",
            UpdatePaymentIntentPaymentMethodOptionsKlarnaSubscriptionsInterval::Month => "month",
            UpdatePaymentIntentPaymentMethodOptionsKlarnaSubscriptionsInterval::Week => "week",
            UpdatePaymentIntentPaymentMethodOptionsKlarnaSubscriptionsInterval::Year => "year",
        }
    }
}

impl AsRef<str> for UpdatePaymentIntentPaymentMethodOptionsKlarnaSubscriptionsInterval {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for UpdatePaymentIntentPaymentMethodOptionsKlarnaSubscriptionsInterval {
    fn default() -> Self {
        Self::Day
    }
}
...
/// An enum representing the possible values of an `UpdatePaymentIntentPaymentMethodOptionsKrCard`'s `capture_method` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl UpdatePaymentIntentPaymentMethodOptionsKrCardCaptureMethod {
    pub fn as_str(self) -> &'static str {
        match self {
            UpdatePaymentIntentPaymentMethodOptionsKrCardCaptureMethod::Manual => "manual",
        }
    }
}

impl AsRef<str> for UpdatePaymentIntentPaymentMethodOptionsKrCardCaptureMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for UpdatePaymentIntentPaymentMethodOptionsKrCardCaptureMethod {
    fn default() -> Self {
        Self::Manual
    }
}

/// An enum representing the possible values of an `UpdatePaymentIntentPaymentMethodOptionsKrCard`'s `setup_future_usage` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl UpdatePaymentIntentPaymentMethodOptionsKrCardSetupFutureUsage {
    pub fn as_str(self) -> &'static str {
        match self {
            UpdatePaymentIntentPaymentMethodOptionsKrCardSetupFutureUsage::None => "none",
            UpdatePaymentIntentPaymentMethodOptionsKrCardSetupFutureUsage::OffSession => "off_session",
        }
    }
}

impl AsRef<str> for UpdatePaymentIntentPaymentMethodOptionsKrCardSetupFutureUsage {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for UpdatePaymentIntentPaymentMethodOptionsKrCardSetupFutureUsage {
    fn default() -> Self {
        Self::None
    }
}
...
/// An enum representing the possible values of an `UpdatePaymentIntentPaymentMethodOptionsNaverPay`'s `capture_method` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl UpdatePaymentIntentPaymentMethodOptionsNaverPayCaptureMethod {
    pub fn as_str(self) -> &'static str {
        match self {
            UpdatePaymentIntentPaymentMethodOptionsNaverPayCaptureMethod::Manual => "manual",
        }
    }
}

impl AsRef<str> for UpdatePaymentIntentPaymentMethodOptionsNaverPayCaptureMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for UpdatePaymentIntentPaymentMethodOptionsNaverPayCaptureMethod {
    fn default() -> Self {
        Self::Manual
    }
}

/// An enum representing the possible values of an `UpdatePaymentIntentPaymentMethodOptionsNaverPay`'s `setup_future_usage` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl UpdatePaymentIntentPaymentMethodOptionsNaverPaySetupFutureUsage {
    pub fn as_str(self) -> &'static str {
        match self {
            UpdatePaymentIntentPaymentMethodOptionsNaverPaySetupFutureUsage::None => "none",
            UpdatePaymentIntentPaymentMethodOptionsNaverPaySetupFutureUsage::OffSession => "off_session",
        }
    }
}

impl AsRef<str> for UpdatePaymentIntentPaymentMethodOptionsNaverPaySetupFutureUsage {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for UpdatePaymentIntentPaymentMethodOptionsNaverPaySetupFutureUsage {
    fn default() -> Self {
        Self::None
    }
}

/// An enum representing the possible values of an `UpdatePaymentIntentPaymentMethodOptionsNzBankAccount`'s `setup_future_usage` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl UpdatePaymentIntentPaymentMethodOptionsNzBankAccountSetupFutureUsage {
    pub fn as_str(self) -> &'static str {
        match self {
            UpdatePaymentIntentPaymentMethodOptionsNzBankAccountSetupFutureUsage::None => "none",
            UpdatePaymentIntentPaymentMethodOptionsNzBankAccountSetupFutureUsage::OffSession => "off_session",
            UpdatePaymentIntentPaymentMethodOptionsNzBankAccountSetupFutureUsage::OnSession => "on_session",
        }
    }
}

impl AsRef<str> for UpdatePaymentIntentPaymentMethodOptionsNzBankAccountSetupFutureUsage {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for UpdatePaymentIntentPaymentMethodOptionsNzBankAccountSetupFutureUsage {
    fn default() -> Self {
        Self::None
    }
}
...
/// An enum representing the possible values of an `UpdatePaymentIntentPaymentMethodOptionsPayco`'s `capture_method` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl UpdatePaymentIntentPaymentMethodOptionsPaycoCaptureMethod {
    pub fn as_str(self) -> &'static str {
        match self {
            UpdatePaymentIntentPaymentMethodOptionsPaycoCaptureMethod::Manual => "manual",
        }
    }
}

impl AsRef<str> for UpdatePaymentIntentPaymentMethodOptionsPaycoCaptureMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for UpdatePaymentIntentPaymentMethodOptionsPaycoCaptureMethod {
    fn default() -> Self {
        Self::Manual
    }
}
...
/// An enum representing the possible values of an `UpdatePaymentIntentPaymentMethodOptionsPix`'s `amount_includes_iof` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl UpdatePaymentIntentPaymentMethodOptionsPixAmountIncludesIof {
    pub fn as_str(self) -> &'static str {
        match self {
            UpdatePaymentIntentPaymentMethodOptionsPixAmountIncludesIof::Always => "always",
            UpdatePaymentIntentPaymentMethodOptionsPixAmountIncludesIof::Never => "never",
        }
    }
}

impl AsRef<str> for UpdatePaymentIntentPaymentMethodOptionsPixAmountIncludesIof {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for UpdatePaymentIntentPaymentMethodOptionsPixAmountIncludesIof {
    fn default() -> Self {
        Self::Always
    }
}
...
/// An enum representing the possible values of an `UpdatePaymentIntentPaymentMethodOptionsSamsungPay`'s `capture_method` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl UpdatePaymentIntentPaymentMethodOptionsSamsungPayCaptureMethod {
    pub fn as_str(self) -> &'static str {
        match self {
            UpdatePaymentIntentPaymentMethodOptionsSamsungPayCaptureMethod::Manual => "manual",
        }
    }
}

impl AsRef<str> for UpdatePaymentIntentPaymentMethodOptionsSamsungPayCaptureMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for UpdatePaymentIntentPaymentMethodOptionsSamsungPayCaptureMethod {
    fn default() -> Self {
        Self::Manual
    }
}

/// An enum representing the possible values of an `UpdatePaymentIntentPaymentMethodOptionsSatispay`'s `capture_method` field.
#[derive(Copy, Clone, Debug, Deserialize, Serialize, Eq, PartialEq)]
#[serde(rename_all = "snake_case")]
...
impl UpdatePaymentIntentPaymentMethodOptionsSatispayCaptureMethod {
    pub fn as_str(self) -> &'static str {
        match self {
            UpdatePaymentIntentPaymentMethodOptionsSatispayCaptureMethod::Manual => "manual",
        }
    }
}

impl AsRef<str> for UpdatePaymentIntentPaymentMethodOptionsSatispayCaptureMethod {
    fn as_ref(&self) -> &str {
        self.as_str()
    }
}
...
impl std::default::Default for UpdatePaymentIntentPaymentMethodOptionsSatispayCaptureMethod {
    fn default() -> Self {
        Self::Manual
    }
}
